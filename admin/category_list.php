                                ...
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            ...
                                            <!--<span class="d-block text-muted pt-2 font-size-sm">ajax row selection and group actions</span>-->
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        <?php
                                        if (hasRight($user_right_title, 'add')) {
                                            echo '<a href="' . $admin_url . 'category" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i>New Record</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
...
?>
    <script>
        ...
        function getAllPageData(filter) {
            loader(true);
            $.ajax({
                type: "POST", url: 'ajax/fetch/categories.php',
                data: {'filters': filter},
