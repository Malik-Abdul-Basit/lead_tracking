                                ...
                                <div class="card-header flex-wrap py-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        if (hasRight($user_right_title, 'add')) {
                                            echo '<a href="' . $admin_url . 'shift" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i>New Record</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
...
?>
    <script>
        ...
        function getData() {
            ...
            var filter = {
                ...
                'Header': [
                    ...
                    {'field': 'name', 'title': 'Name', 'text': 'left', 'style': 'style="width:200px"', 'sort': true},
                    {
                        'field': 'from',
                        'title': 'From (Start)',
                        'text': 'left',
                    ...
                    {'field': 'to', 'title': 'To (End)', 'text': 'left', 'style': 'style="width:125px"', 'sort': true},
                    {
                        'field': 'sort_by',
                        'title': 'Sort By',
                        'text': 'left',
        ...
        function getAllShifts(filter) {
            loader(true);
            $.ajax({
                type: "POST", url: 'ajax/fetch/shifts.php',
                data: {'filters': filter},
