                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                if (isset($_GET['id'])) {
                                                    ...
                                                    $Q = "SELECT * FROM `departments` WHERE `id`='{$id}' AND `company_id`='{$global_company_id}' AND `branch_id`='{$global_branch_id}' AND `deleted_at` IS NULL";
    ...
    <script>
        function saveFORM() {
            ...
            if (id.value == 0 && A == '') {
                ...
                loader(true);
                var postData = {"id": id.value, "name": name.value, "sort_by": sort_by.value,"user_right_title": '<?php echo $user_right_title; ?>'};
                $.ajax({
                    type: "POST", url: "ajax/department.php",
