                                ...
                                <div class="card-header flex-wrap py-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        if (hasRight($user_right_title, 'add')) {
                                            echo '<a href="' . $admin_url . 'sub_category" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i>New Record</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function getData() {
            ...
            var filter = {
                ...
                'Filter': [
                    {'field': 'sc.category_id', 'value': BG_CategoryFilter.value},
                ],
                'Numbering': {
                    'field': 'sr',
                    'title': '#',
        ...
        function getAllPageData(filter) {
            loader(true);
            $.ajax({
                type: "POST", url: 'ajax/fetch/sub_categories.php',
                data: {'filters': filter},
