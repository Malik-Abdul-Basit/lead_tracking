                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                if (isset($_GET['id'])) {
                                                    ...
                                                    $Q = "SELECT * FROM `evaluation_default_questions` WHERE `id`='{$id}'  AND `company_id`='{$global_company_id}' AND `branch_id`='{$global_branch_id}' AND `deleted_at` IS NULL";
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="designation_id" <?php echo $TAttrs . $onblur; ?>>
                                                                        <?php
                                                ...
                                                <div class="mb-3">
                                                    <div class="mb-2"
                                                        ...
                                                        <div id="Targets_Holder_Parent_Div" style="max-height: 100%;">
                                                            ...
                                                            $query_evaluation_tasks = mysqli_query($db, "SELECT `id`, `task_heading`, `task_weight` FROM `evaluation_default_tasks` WHERE `eval_default_question_id` = '{$id}'");
                                                                        ...
                                                                        <div class="row mt-7">
                                                                            <div class="col-md-6 column">
                                                                                <label class="checkbox checkbox-outline checkbox-success float-left"
                                                                                       style="margin: 10px 0 0 0; width: 60px !important;">
                                                                                    <input type="checkbox"
...
?>
    <script type='text/javascript'>
        ...
        function addNewSection() {
            ...
            innerHTML += '<label class="checkbox checkbox-outline checkbox-success float-left" style="margin: 10px 0 0 0; width: 60px !important;">';
        ...
        function saveFORM() {
            ...
            select2_department_id_container.style.borderColor = select2_designation_id_container.style.borderColor = '#E4E6EF';
            errorMessageDepartment.innerText = errorMessageDesignation.innerText = "";
            ...
            if (id.value == 0 && A == '') {
                ...
                if (continueProcessing === false) {
                    ...
                    return false;
                } else if (continueProcessing === true && continueTask === true && data.length > 0) {
                    loader(true);
                    var postData = {
                        "id": id.value,
                    ...
                    $.ajax({
                        type: "POST", url: "ajax/evaluation_default_question.php",
                                    ...
                                    if (obj.code === 422) {
                                        if (obj.errorField !== undefined && obj.errorField != '' && obj.errorMessage !== undefined && obj.errorMessage != '' && obj.toasterClass !== undefined && obj.toasterClass != '') {
                                            if (obj.errorField == 'department_id') {
                                                select2_department_id_container.style.borderColor = '#F00';
                                            } else if (obj.errorField == 'designation_id') {
                                                select2_designation_id_container.style.borderColor = '#F00';
                                            } else {
