                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                if (isset($_GET['id'])) {
                                                    ...
                                                    $Q = "SELECT * FROM `categories` WHERE `id`='{$id}' AND `company_id`='{$global_company_id}' AND `branch_id`='{$global_branch_id}' AND `deleted_at` IS NULL";
    ...
    <script>
        function saveFORM() {
            ...
            if (id.value == 0 && A == '') {
                ...
                $.ajax({
                    type: "POST", url: "ajax/category.php",
