                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                if (isset($_GET['id'])) {
                                                    ...
                                                    $Q = "SELECT * FROM `sub_categories` WHERE `id`='{$id}' AND `company_id`='{$global_company_id}' AND `branch_id`='{$global_branch_id}' AND `deleted_at` IS NULL";
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select tabindex="20"
                                                                                ...
                                                                                <?php
                                                                                $select = "SELECT `id`,`name` FROM `categories` WHERE `company_id`='{$global_company_id}' AND `branch_id`='{$global_branch_id}' AND `deleted_at` IS NULL ORDER BY `sort_by` ASC";
...
?>
    <script>
        function saveFORM() {
            ...
            name.style.borderColor = select2_category_id_container.style.borderColor = sort_by.style.borderColor = '#E4E6EF';
            errorMessageName.innerText = errorMessageCategory.innerText = errorMessageSortBy.innerText = "";
            ...
            if (id.value == 0 && A == '') {
                ...
                errorMessageCategory.innerText = "Category field is required.";
                return false;
            } else if (isNaN(category_id.value) === true || category_id.value.length > 10 || category_id.value < 0) {
                select2_category_id_container.style.borderColor = '#F00';
                errorMessageCategory.innerText = "Please select a valid option.";
                return false;
                ...
                $.ajax({
                    type: "POST", url: "ajax/sub_category.php",
                                ...
                                if (obj.code === 422) {
                                    ...
                                    if (obj.responseMessage !== undefined && obj.responseMessage != '') {
                                        if (obj.form_reset !== undefined && obj.form_reset) {
                                            ...
                                            var select2_categoryId_container = document.getElementById("select2-category_id-container");

                                            if (select2_categoryId_container) {
                                                select2_categoryId_container.removeAttribute("title");
                                                select2_categoryId_container.innerHTML = '<span class="select2-selection__placeholder">Select</span>';
                                            }
                                        }
                                        loader(false);
