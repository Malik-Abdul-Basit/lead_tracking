                                    ...
                                    <div class="card-header flex-wrap py-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            if (hasRight($user_right_title, 'add')) {
                                                echo '<a href="' . $admin_url . 'salary_grade" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i>New Record</a>';
                                            }
                                            ?>
                                        </div>
                                    </div>
...
<script>
    ...
    function getData() {
        ...
        var filter = {
            ...
            'Filter': [
                {'field': 'sg.department_id', 'value': BG_DepartmentFilter.value},
            ],
            "PageSizeStack": ["5", "10", "20", "30", "40", "50"]
        };
        getAllSalaryGrade(filter);
    }

    function getAllSalaryGrade(filter) {
        loader(true);
        $.ajax({
            type: "POST", url: 'ajax/fetch/salary_grades.php',
            data: {'filters': filter},
