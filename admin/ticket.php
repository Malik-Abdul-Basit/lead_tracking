                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea rows="5" <?php echo $TAttrs . $onblur; ?> tabindex="10" id="description" placeholder="Description"></textarea>
                                                                            <div class="error_wrapper">
                                                                        <span class="text-danger"
                                                                              id="errorMessageDescription"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select tabindex="20"
                                                                                    id="priority" <?php echo $TAttrs . $onblur; ?>>
                                                                                <option selected="selected" value="">
                                                                                    Select
                                                                                </option>
                                                                            </select>
