                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-3 my-2 my-md-0">
                                                            <div class="form-group">
                                                                <label for="BG_EvaluationTypeFilter">Evaluation
                                                                    Type</label>
                                                                <select class="form-control"
                                                                        id="BG_EvaluationTypeFilter"
                                                                        onchange="getData()">
                                                        ...
                                                        <div class="col-md-3 my-2 my-md-0">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control"
                                                                        ...
                                                                        onchange="getData(), getRelatedSalaryBands(this.value)">
                                                        ...
                                                        <div class="col-md-3 my-2 my-md-0">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control"
                                                                        ...
                                                                        onchange="getData()">
                                                                    <?php
                                                                    echo getRelatedSalaryBands('0', '0', $global_company_id, $global_branch_id);
                                                                    ?>
                                                                </select>
                                                            </div>
                                                        </div>
...
<script>
    ...
    function getData() {
        ...
        var BG_EvaluationTypeFilter = document.getElementById('BG_EvaluationTypeFilter');
        ...
        var filter = {
            ...
            'Filter': [
                {'field': 'gp.evaluation_type_id', 'value': BG_EvaluationTypeFilter.value},
                {'field': 'gp.department_id', 'value': BG_DepartmentFilter.value},
                {'field': 'gp.salary_grade_id', 'value': BG_SalaryBandFilter.value},
            ],
            "PageSizeStack": ["5", "10", "20", "30", "40", "50"]
        };
        getAllGradingPolicies(filter);
    }

    function getAllGradingPolicies(filter) {
        loader(true);
        $.ajax({
            type: "POST", url: 'ajax/fetch/grading_policies.php',
            data: {'filters': filter},
