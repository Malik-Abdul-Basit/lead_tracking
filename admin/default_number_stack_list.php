                                    ...
                                    <div class="card-header flex-wrap py-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            if (hasRight($user_right_title, 'add')) {
                                                echo '<a href="' . $admin_url . 'default_number_stack" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i>New Record</a>';
                                            }
                                            ?>
                                        </div>
                                    </div>
...
<script>
    ...
    function getAllNumberStacks(filter) {
        loader(true);
        $.ajax({
            type: "POST", url: 'ajax/fetch/default_number_stacks.php',
            data: {'filters': filter},
            ...
            if (result.value) {
                ...
                if (D) {
                    ...
                    $.ajax({
                        ...
                        data: "delete_default_evaluation_number_stack=" + id,
                        success: function (resPonse) {
                            if (resPonse !== undefined && resPonse != '') {
                                var obj = JSON.parse(resPonse);
