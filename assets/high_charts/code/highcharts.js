...
(function (T, K) {
    "object" === typeof module && module.exports
        ? (module.exports = T.document ? K(T) : K)
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0],
                    ...
                    q;
                if (1 === r) f = this.toD;
                else if (y === h.length && 1 > r) for (; y--; ) (q = parseFloat(a[y])), (f[y] = isNaN(q) ? h[y] : r * parseFloat(h[y] - q) + q);
                else f = h;
            ...
            run: function (m, h, f) {
                ...
                m !== h || this.elem["forceAnimate:" + this.prop]
                    ? ((this.startTime = +new Date()), (this.start = m), (this.end = h), (this.unit = f), (this.now = this.start), (this.pos = 0), (q.elem = this.elem), (q.prop = this.prop), q() && 1 === a.timers.push(q) && w(e))
                    : (delete y.curAnim[this.prop], y.complete && 0 === a.keys(y.curAnim).length && y.complete.call(this.elem));
            },
            step: function (m) {
                var h = +new Date(),
                    f,
                ...
                y.attr && !y.element
                    ...
                    ? ((this.now = this.end),
                      ...
                      f && q && q.call(y),
                      (m = !1))
                    : ((this.pos = r.easing((h - this.startTime) / w)), (this.now = this.start + (this.end - this.start) * this.pos), this.update(), (m = !0));
                return m;
            },
            initPath: function (m, h, f) {
                function r(a) {
                    var d, k;
                    for (b = a.length; b--; ) (d = "M" === a[b] || "L" === a[b]), (k = /[a-zA-Z]/.test(a[b + 3])), d && k && a.splice(b + 1, 0, a[b + 1], a[b + 2], a[b + 1], a[b + 2]);
                }
                function y(a, d) {
                    for (; a.length < k; ) {
                        a[0] = d[k - a.length];
        ...
        a.attr = function (m, h, f) {
            ...
            a.isString(h)
                ? a.defined(f)
                    ? m.setAttribute(h, f)
                    : m && m.getAttribute && ((r = m.getAttribute(h)) || "class" !== h || (r = m.getAttribute(h + "Name")))
                : a.defined(h) &&
                  a.isObject(h) &&
        ...
        a.createElement = function (m, h, f, r, y) {
            ...
            var q = a.css;
            h && a.extend(m, h);
            y && q(m, { padding: 0, border: "none", margin: 0 });
            f && q(m, f);
            r && r.appendChild(m);
            return m;
        };
        ...
        a.normalizeTickInterval = function (m, h, f, r, y) {
            ...
            q = m / f;
            h ||
                ((h = y ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
                !1 === r &&
                    (1 === f
            ...
            return (w = a.correctFloat(w * f, -Math.round(Math.log(0.001) / Math.LN10)));
        };
        ...
        a.numberFormat = function (m, h, f, r) {
            ...
            -1 === h
                ? (h = Math.min(q, 20))
                : a.isNumber(h)
                ? h && c[1] && 0 > c[1] && ((w = h + +c[1]), 0 <= w ? ((c[0] = (+c[0]).toExponential(w).split("e")[0]), (h = w)) : ((c[0] = c[0].split(".")[0] || 0), (m = 20 > h ? (c[0] * Math.pow(10, c[1])).toFixed(h) : 0), (c[1] = 0)))
                : (h = 2);
        ...
        a.getStyle = function (m, h, f) {
            ...
            if ((m = E.getComputedStyle(m, void 0))) (m = m.getPropertyValue(h)), a.pick(f, "opacity" !== h) && (m = a.pInt(m));
            return m;
        };
        ...
        a.offset = function (a) {
            ...
            return { top: a.top + (E.pageYOffset || h.scrollTop) - (h.clientTop || 0), left: a.left + (E.pageXOffset || h.scrollLeft) - (h.clientLeft || 0) };
        };
        a.stop = function (m, h) {
        ...
        a.fireEvent = function (m, h, f, r) {
            var y, q, w, e, c;
            f = f || {};
            D.createEvent && (m.dispatchEvent || m.fireEvent)
                ? ((y = D.createEvent("Events")), y.initEvent(h, !0, !0), a.extend(y, f), m.dispatchEvent ? m.dispatchEvent(y) : m.fireEvent(h, y))
        ...
        a.animate = function (m, h, f) {
            var r,
                ...
                w,
                e;
            a.isObject(f) || ((e = arguments), (f = { duration: e[2], easing: e[3], complete: e[4] }));
        ...
        a.Color.prototype = {
            ...
            init: function (f) {
                ...
                if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops)
                    ...
                    for (q = this.parsers.length; q-- && !y; ) (w = this.parsers[q]), (h = w.regex.exec(f)) && (y = w.parse(h));
                this.rgba = y || [];
            },
            get: function (a) {
                var f = this.input,
            ...
            brighten: function (a) {
                ...
                else if (D(a) && 0 !== a) for (f = 0; 3 > f; f++) (y[f] += h(255 * a)), 0 > y[f] && (y[f] = 0), 255 < y[f] && (y[f] = 255);
                return this;
            },
            ...
            tweenTo: function (a, h) {
                ...
                q.length && f && f.length
                    ? ((a = 1 !== q[3] || 1 !== f[3]),
                      (h =
                          (a ? "rgba(" : "rgb(") +
                          Math.round(q[0] + (f[0] - q[0]) * (1 - h)) +
                          "," +
                          Math.round(q[1] + (f[1] - q[1]) * (1 - h)) +
                          "," +
                          Math.round(q[2] + (f[2] - q[2]) * (1 - h)) +
                          (a ? "," + (q[3] + (f[3] - q[3]) * (1 - h)) : "") +
                          ")"))
                    : (h = a.input || "none");
                return h;
    ...
    (function (a) {
        ...
        k(C.prototype, {
            ...
            complexColor: function (A, g, b) {
                ...
                a.fireEvent(this.renderer, "complexColor", { args: arguments }, function () {
                    ...
                    k &&
                        ...
                        (l = A.stops),
                        (R = b.radialReference),
                        H(c) && (A[k] = c = { x1: c[0], y1: c[1], x2: c[2], y2: c[3], gradientUnits: "userSpaceOnUse" }),
                        "radialGradient" === k && R && !w(c.gradientUnits) && ((n = c), (c = G(c, d.getRadialAttr(R, n), { gradientUnits: "userSpaceOnUse" }))),
                        M(c, function (a, A) {
                            "id" !== A && t.push(A, a);
                        }),
                        M(l, function (a) {
                        ...
                        e[t]
                            ...
                            : ((c.id = p = a.uniqueKey()),
                              ...
                              z(l, function (A) {
                                  ...
                                  A = d.createElement("stop").attr({ offset: A[0], "stop-color": B, "stop-opacity": u }).add(J);
                                  J.stops.push(A);
                              })),
                        (x = "url(" + d.url + "#" + p + ")"),
                        b.setAttribute(g, x),
            ...
            applyTextOutline: function (A) {
                ...
                if ((k = A[0]) && "none" !== k && a.svg) {
                    ...
                    for (n = A.length; n--; ) (b = A[n]), "highcharts-text-outline" === b.getAttribute("class") && d(A, g.removeChild(b));
                    c = g.firstChild;
                    z(A, function (a, A) {
                        0 === A && (a.setAttribute("x", g.getAttribute("x")), (A = g.getAttribute("y")), a.setAttribute("y", A || 0), null === A && g.setAttribute("y", 0));
                        a = a.cloneNode(1);
                        h(a, { class: "highcharts-text-outline", fill: v, stroke: v, "stroke-width": k, "stroke-linejoin": "round" });
                        g.insertBefore(a, c);
                    });
                }
            },
            attr: function (a, g, b, d) {
                var A,
                    ...
                    n,
                    J;
                "string" === typeof a && void 0 !== g && ((A = a), (a = {}), (a[A] = g));
                "string" === typeof a
                    ? (c = (this[a + "Getter"] || this._defaultGetter).call(this, a, v))
                    : (M(
                          a,
                          function (A, g) {
                              n = !1;
            ...
            updateShadows: function (a, g, b) {
                for (var A = this.shadows, d = A.length; d--; ) b.call(A[d], "height" === a ? Math.max(g - (A[d].cutHeight || 0), 0) : "d" === a ? this.d : g, a, A[d]);
            },
            ...
            align: function (a, g, b) {
                ...
                var J, e;
                if (a) {
                    if (((this.alignOptions = a), (this.alignByTranslate = g), !b || I(b))) (this.alignTo = A = b || "renderer"), d(c, this), c.push(this), (b = null);
                } else (a = this.alignOptions), (g = this.alignByTranslate), (A = this.alignTo);
                b = F(b, v[A], v);
                A = a.align;
                v = a.verticalAlign;
                c = (b.x || 0) + (a.x || 0);
            ...
            getBBox: function (a, g) {
                ...
                if (!A) {
                    if (v.namespaceURI === this.SVG_NS || b.forExport) {
                        try {
                            (l =
                                ...
                                (A = v.getBBox ? k({}, v.getBBox()) : { width: v.offsetWidth, height: v.offsetHeight }),
                                l && l("");
                        } catch (W) {}
                    ...
                    b.isSVG &&
                        ...
                        g && ((A.width = Math.abs(b * Math.sin(d)) + Math.abs(a * Math.cos(d))), (A.height = Math.abs(b * Math.cos(d)) + Math.abs(a * Math.sin(d)))));
                    if (p && 0 < A.height) {
            ...
            destroy: function () {
                ...
                c &&
                    v &&
                    (z(v.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
            ...
            shadow: function (a, g, b) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    for (d = 1; d <= n; d++)
                        (v = c.cloneNode(0)),
                            (k = 2 * n + 1 - 2 * d),
                            h(v, { isShadow: "true", stroke: a.color || "#000000", "stroke-opacity": J * d, "stroke-width": k, transform: "translate" + e, fill: "none" }),
                ...
                if (c) {
                    ...
                    for (e = b.length - 1; 0 <= e && !n; e--)
                        if (((v = b[e]), (c = v.getAttribute("data-z-index")), (J = !w(c)), v !== k))
                            if (0 > a && J && !d && !e) A.insertBefore(k, b[e]), (n = !0);
                            else if (g(c) <= a || (J && (!w(a) || 0 <= a))) A.insertBefore(k, b[e + 1] || null), (n = !0);
        ...
        C.prototype["stroke-widthSetter"] = C.prototype.strokeSetter = function (a, g, b) {
            ...
            this.stroke && this["stroke-width"]
                ? (C.prototype.fillSetter.call(this, this.stroke, "stroke", b), b.setAttribute("stroke-width", this["stroke-width"]), (this.hasStroke = !0))
                : "stroke-width" === g && 0 === a && this.hasStroke && (b.removeAttribute("stroke"), (this.hasStroke = !1));
        };
        ...
        k(D.prototype, {
            ...
            init: function (a, g, b, d, v, c) {
                ...
                this.alignedObjects = [];
                this.url =
                    (t || n) && l.getElementsByTagName("base").length
                        ? N.location.href
                              .split("#")[0]
                              .replace(/<[^>]*>/g, "")
                              .replace(/([\('\)])/g, "\\$1")
                              .replace(/ /g, "%20")
                        : "";
                this.createElement("desc").add().element.appendChild(l.createTextNode("Created with Highcharts 6.1.3"));
                ...
                t &&
                    ...
                    ((g = function () {
                        ...
                        y(a, { left: Math.ceil(k.left) - k.left + "px", top: Math.ceil(k.top) - k.top + "px" });
                    }),
                    g(),
                    (this.unSubPixelFix = E(N, "resize", g)));
            },
            getStyle: function (a) {
                return (this.style = k({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "12px" }, a));
            },
            setStyle: function (a) {
            ...
            applyEllipsis: function (a, g, b, d) {
                ...
                if ((e = c > d)) {
                    for (; A <= n; ) (k = Math.ceil((A + n) / 2)), (c = b.substring(0, k) + "\u2026"), J(c), (c = this.getSpanWidth(a, g)), A === n ? (A = n + 1) : c > d ? (n = k - 1) : (A = k);
                    0 === n && J("");
                }
                a.rotation = v;
                return e;
            ...
            buildText: function (a) {
                ...
                if (w !== a.textCache) {
                    ...
                    A || x || f || t || -1 !== k.indexOf(" ")
                          ...
                          z(k, function (g, b) {
                              ...
                              z(k, function (g) {
                                  if ("" !== g || 1 === k.length) {
                                      ...
                                      if ((p = m(g, "style"))) (p = p.replace(/(;| |^)color([ :])/, "$1fill$2")), h(u, "style", p);
                                      (G = m(g, "href")) && !c && (h(u, "onclick", 'location.href\x3d"' + G + '"'), h(u, "class", "highcharts-anchor"), y(u, { cursor: "pointer" }));
                                      ...
                                      if (" " !== g) {
                                          ...
                                          h(u, n);
                                          d.appendChild(u);
                                          !A && q && (!Q && c && y(u, { display: "block" }), h(u, "dy", I(u)));
                                          if (t) {
                                              ...
                                              for (f && (e = v.applyEllipsis(a, u, g, t)); !f && G && (n.length || x.length); )
                                                  (a.rotation = 0),
                                                      ...
                                                      void 0 === e && (e = g),
                                                      g && 1 !== n.length
                                                          ? (u.removeChild(u.firstChild), x.unshift(n.pop()))
                                                          : ((n = x), (x = []), n.length && !P && ((u = l.createElementNS(J, "tspan")), h(u, { dy: O, x: B }), p && h(u, "style", p), d.appendChild(u)), z > t && (t = z + 1)),
                        ...
                        : d.appendChild(l.createTextNode(N(k)));
                }
            },
            ...
            button: function (a, g, b, d, v, c, n, e, J) {
                var A = this.label(a, g, b, J, null, null, null, null, "button"),
                    u = 0;
                A.attr(G({ padding: 8, r: 2 }, v));
                var l, B, p, t;
                v = G({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1, style: { color: "#333333", cursor: "pointer", fontWeight: "normal" } }, v);
                l = v.style;
                delete v.style;
                c = G(v, { fill: "#e6e6e6" }, c);
                B = c.style;
                delete c.style;
                n = G(v, { fill: "#e6ebf5", style: { color: "#000000", fontWeight: "bold" } }, n);
                p = n.style;
                delete n.style;
                e = G(v, { style: { color: "#cccccc" } }, e);
                t = e.style;
                delete e.style;
                ...
                A.attr(v).css(k({ cursor: "default" }, l));
            ...
            arc: function (a, g, b, d, v, c) {
                x(a) ? ((d = a), (g = d.y), (b = d.r), (a = d.x)) : (d = { innerR: d, start: v, end: c });
            ...
            rect: function (a, g, b, d, v, c) {
                ...
                a = x(a) ? a : void 0 === a ? {} : { x: a, y: g, width: Math.max(b, 0), height: Math.max(d, 0) };
            ...
            image: function (a, g, b, d, v, c) {
                ...
                1 < arguments.length && k(n, { x: g, y: b, width: d, height: v });
            ...
            symbol: function (a, g, b, d, v, c) {
                var n = this,
                    ...
                    G;
                B
                    ? ((e = this.path(p)), e.attr("fill", "none"), k(e, { symbolName: u, x: g, y: b, width: d, height: v }), c && k(e, c))
                    : A &&
                      ((t = a.match(J)[1]),
                      (e = this.image(t)),
                      ...
                      w(g) && e.attr({ x: g, y: b }),
                      (e.isImg = !0),
                      w(e.imgwidth) && w(e.imgheight)
                          ? G()
                          : (e.attr({ width: 0, height: 0 }),
                            q("img", {
                                onload: function () {
                                    var a = f[n.chartIndex];
                                    0 === this.width && (y(this, { position: "absolute", top: "-999em" }), l.body.appendChild(this));
                                    O[t] = { width: this.width, height: this.height };
            ...
            symbols: {
                ...
                arc: function (a, g, b, d, v) {
                    var c = v.start,
                        ...
                        e = v.end - 0.001;
                    b = v.innerR;
                    d = F(v.open, 0.001 > Math.abs(v.end - v.start - 2 * Math.PI));
                    var J = Math.cos(c),
                        u = Math.sin(c),
                        A = Math.cos(e),
                        e = Math.sin(e);
                    v = 0.001 > v.end - c - Math.PI ? 0 : 1;
                ...
                callout: function (a, g, b, d, v) {
                    ...
                    n && n > b
                        ? v > g + k && v < g + d - k
                            ? e.splice(13, 3, "L", a + b, v - 6, a + b + 6, v, a + b, v + 6, a + b, g + d - c)
                            : e.splice(13, 3, "L", a + b, d / 2, n, v, a + b, d / 2, a + b, g + d - c)
                        : n && 0 > n
                        ? v > g + k && v < g + d - k
                            ? e.splice(33, 3, "L", a, v + 6, a - 6, v, a, v - 6, a, g + c)
                            : e.splice(33, 3, "L", a, d / 2, n, v, a, d / 2, a, g + c)
                        : v && v > d && n > a + k && n < a + b - k
                        ? e.splice(23, 3, "L", n + 6, g + d, n, g + d + 6, n - 6, g + d, a + c, g + d)
                        : v && 0 > v && n > a + k && n < a + b - k && e.splice(3, 3, "L", n - 6, g, n, g - 6, n + 6, g, b - c, g);
                    return e;
                },
            },
            clipRect: function (g, b, d, v) {
                var c = a.uniqueKey(),
                    k = this.createElement("clipPath").attr({ id: c }).add(this.defs);
            ...
            text: function (a, g, b, d) {
                ...
                d ||
                    (a.xSetter = function (a, g, b) {
                        var d = b.getElementsByTagName("tspan"),
                            v,
                            c = b.getAttribute(g),
                            k;
                        for (k = 0; k < d.length; k++) (v = d[k]), v.getAttribute(g) === c && v.setAttribute(g, a);
                        b.setAttribute(g, a);
                    });
                return a;
            },
            fontMetrics: function (a, b) {
                ...
                return { h: b, b: Math.round(0.8 * b), f: a };
            },
            ...
            label: function (g, b, d, c, n, e, J, u, l) {
                var B = this,
                    ...
                    t = (p.text = B.text("", 0, 0, J).attr({ zIndex: 1 })),
                    A,
                    x,
                    Q = 0,
                    f = 3,
                ...
                r = function () {
                    ...
                    m &&
                        (A ||
                            ((p.box = A = B.symbols[c] || M ? B.symbol(c) : B.rect()),
                ...
                R = function () {
                    var a = P + f,
                        g;
                    g = u ? 0 : y;
                    w(h) && x && ("center" === H || "right" === H) && (a += { center: 0.5, right: 1 }[H] * (h - x.width));
                    if (a !== t.x || g !== t.y) t.attr("x", a), t.hasBoxWidthChanged && ((x = t.getBBox(!0)), r()), void 0 !== g && t.attr("y", g);
                    t.x = a;
                    t.y = g;
                };
                U = function (a, g) {
                ...
                return k(p, {
                    ...
                    getBBox: function () {
                        return { width: x.width + 2 * f, height: x.height + 2 * f, x: x.x - f, y: x.y - f };
                    },
                    shadow: function (a) {
                        a && (r(), A && A.shadow(a));
                        return p;
    ...
    (function (a) {
        ...
        f(a.SVGElement.prototype, {
            htmlCss: function (a) {
                var d = this.element;
                if ((d = a && "SPAN" === d.tagName && a.width) || (this.textWidth && !d)) delete a.width, (this.textWidth = d), this.htmlUpdateTransform();
            ...
            htmlUpdateTransform: function () {
                if (this.added) {
                    var a = this.renderer,
                        ...
                        f = { left: 0, center: 0.5, right: 1 }[t],
                        x = this.styles,
                        z = x && x.whiteSpace;
                    E(d, { marginLeft: b, marginTop: c });
                    this.shadows &&
                        h(this.shadows, function (a) {
                            E(a, { marginLeft: b + 1, marginTop: c + 1 });
                        });
                    this.inverted &&
                        h(d.childNodes, function (b) {
                            a.invertChild(b, d);
                        });
                    if ("SPAN" === d.tagName) {
                        var x = this.rotation,
                            ...
                            B;
                        (B = n !== this.oldTextWidth) && !(B = n > this.oldTextWidth) && ((B = this.textPxLength) || (E(d, { width: "", whiteSpace: z || "nowrap" }), (B = d.offsetWidth)), (B = B > n));
                        B && /[ \-]/.test(d.textContent || d.innerText) ? (E(d, { width: n + "px", display: "block", whiteSpace: z || "normal" }), (this.oldTextWidth = n), (this.hasBoxWidthChanged = !0)) : (this.hasBoxWidthChanged = !1);
                        G !== this.cTT &&
                            ((z = a.fontMetrics(d.style.fontSize).b),
                        ...
                        E(d, { left: p + (this.xCorr || 0) + "px", top: l + (this.yCorr || 0) + "px" });
                        this.cTT = G;
                        this.oldRotation = x;
                        this.oldAlign = t;
                    }
        ...
        f(c.prototype, {
            ...
            html: function (a, d, b) {
                ...
                c.attr({ text: a, x: Math.round(d), y: Math.round(b) }).css({ fontFamily: this.style.fontFamily, fontSize: this.style.fontSize, position: "absolute" });
                                ...
                                h(p.reverse(), function (a) {
                                    ...
                                    b = a.div =
                                        ...
                                        D(
                                            "div",
                                            g,
                                            { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px", display: a.display, opacity: a.opacity, pointerEvents: a.styles && a.styles.pointerEvents },
                                            b || d
                                        );
                                    n = b.style;
                                    f(a, {
                                        ...
                                        on: function () {
                                            p[0].div && c.on.apply({ element: p[0].div }, arguments);
                                            return a;
                                        },
                                        translateXSetter: k,
                                        translateYSetter: k,
    ...
    (function (a) {
        ...
        a.Time.prototype = {
            ...
            update: function (a) {
                ...
                (this.variableTimezone = !(f && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset
                    ? ((this.get = function (a, c) {
                      ...
                      (this.set = function (a, c, l) {
                          ...
                          else (e = w.getTimezoneOffset(c)), (e = c.getTime() - e), c.setTime(e), c["setUTC" + a](l), (a = w.getTimezoneOffset(c)), (e = c.getTime() + a), c.setTime(e);
                      }))
                    : f
                    ? ((this.get = function (a, c) {
                          return c["getUTC" + a]();
            ...
            makeTime: function (f, q, w, e, c, l) {
                var z, k, d;
                this.useUTC
                    ? ((z = this.Date.UTC.apply(0, arguments)), (k = this.getTimezoneOffset(z)), (z += k), (d = this.getTimezoneOffset(z)), k !== d ? (z += d - k) : k - 36e5 !== this.getTimezoneOffset(z - 36e5) || a.isSafari || (z -= 36e5))
                    : (z = new this.Date(f, q, h(w, 1), h(e, 0), h(c, 0), h(l, 0)).getTime());
                return z;
            },
            ...
            getTimeTicks: function (a, q, w, e) {
                        ...
                        l.push(d),
                            (d =
                                b === f.year
                                    ...
                                    : !p || (b !== f.day && b !== f.week)
                                    ? p && b === f.hour && 1 < u
                                        ? c.makeTime(k, e, H, t + q * u)
                                        : d + b * u
                                    : c.makeTime(k, e, H + q * u * (b === f.day ? 1 : 7))),
                            q++;
                    l.push(d);
                    b <= f.hour &&
                        1e4 > l.length &&
                ...
                l.info = E(a, { higherRanks: z, totalRange: b * u });
                return l;
            },
        };
    })(K);
    ...
    (function (a) {
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                this.isFirst = b;
                this.isLast = u;
                h = { axis: a, chart: e, isFirst: b, isLast: u, dateTimeLabelFormat: p, value: a.isLog ? C(a.lin2log(l)) : l, pos: z };
                h = a.labelFormatter.call(h, h);
                if (D(c)) c && c.attr({ text: h });
                else {
            ...
            handleOverflow: function (a) {
                var f = this.axis,
                    ...
                    d = this.label,
                    b = this.rotation,
                    u = { left: 0, center: 0.5, right: 1 }[f.labelAlign || d.attr("align")],
                    p = d.getBBox().width,
                ...
                if (b || !1 === e.overflow) 0 > b && c - u * p < k ? (x = Math.round(c / Math.cos(b * y) - k)) : 0 < b && c + u * p > z && (x = Math.round((l - c) / Math.cos(b * y)));
                    ...
                    ((l = c + (1 - u) * p),
                    c - u * p < k ? (t = a.x + t * (1 - u) - k) : l > z && ((t = z - a.x + t * u), (q = -1)),
                    (t = Math.min(h, t)),
            ...
            getLabelPosition: function (a, f, e, c, l, h, k, d) {
                var b = this.axis,
                    ...
                    p = b.reversed,
                    z = b.staggerLines,
                    t = b.tickRotCorr || { x: 0, y: 0 },
                    w = l.y,
                    x = c || b.reserveSpaceDefault ? 0 : -b.labelOffset * ("center" === b.labelAlign ? 0.5 : 1),
                    q = {};
                ...
                q.x = a;
                q.y = Math.round(f);
                m(this, "afterGetLabelPosition", { pos: q });
                return q;
            },
            ...
            renderGridLine: function (a, f, e) {
                ...
                h ||
                    ...
                    (this.gridLine = h = p
                        ...
                        .add(c.gridGroup)));
                if (!a && h && (a = c.getPlotLinePath(d + u, h.strokeWidth() * e, a, !0))) h[this.isNew ? "attr" : "animate"]({ d: a, opacity: f });
            },
                ...
                b &&
                    ...
                    p &&
                        ((this.mark = u = h
                            ...
                            .add(c.axisGroup)),
                        u.attr({ stroke: l, "stroke-width": t })),
                    u[p ? "attr" : "animate"]({ d: this.getMarkPath(H, a, b[0], u.strokeWidth() * e, c.horiz, h), opacity: f }));
            },
            renderLabel: function (a, f, e, c) {
                ...
                d &&
                    h(H) &&
                    ((d.xy = a = this.getLabelPosition(H, a, d, z, b, l, c, u)),
                    ...
                    u && c % u && (p = !1),
                    p && h(a.y) ? ((a.opacity = e), d[this.isNewLabel ? "attr" : "animate"](a), (this.isNewLabel = !1)) : (d.attr("y", -9999), (this.isNewLabel = !0)));
            },
    ...
    var V = (function (a) {
        ...
        a.extend(F.prototype, {
            defaultOptions: {
                ...
                endOnTick: !1,
                labels: { enabled: !0, x: 0, style: { color: "#666666", cursor: "default", fontSize: "11px" } },
                maxPadding: 0.01,
                minorTickLength: 2,
            ...
            defaultLabelFormatter: function () {
                ...
                else if (p && 1e3 <= g) for (; p-- && void 0 === l; ) (d = Math.pow(n, p + 1)), g >= d && 0 === (10 * b) % d && null !== e[p] && 0 !== b && (l = a.numberFormat(b / d, -1) + e[p]);
                            ...
                            if (a.isXAxis)
                                (v = g.xData),
                                    v.length &&
                                        ((g = m(v)),
                                        (k = E(v)),
                                        p(g) || g instanceof Date || ((v = d(v, p)), (g = m(v)), (k = E(v))),
                                        v.length && ((a.dataMin = Math.min(I(a.dataMin, v[0], g), g)), (a.dataMax = Math.max(I(a.dataMax, v[0], k), k))));
                            else if (
                                (g.getExtremes(),
                                (k = g.dataMax),
                                (g = g.dataMin),
                                y(g) && y(k) && ((a.dataMin = Math.min(I(a.dataMin, g), g)), (a.dataMax = Math.max(I(a.dataMax, k), k))),
                                y(c) && (a.threshold = c),
            ...
            adjustForMinRange: function () {
                ...
                d - b < this.minRange &&
                    ...
                    (d = m(d)),
                    d - b < f && ((c[0] = d - f), (c[1] = I(a.min, d - f)), (b = E(c))));
                this.min = b;
                this.max = d;
            },
            getClosest: function () {
            ...
            setAxisTranslation: function (a) {
                ...
                if (B || u || d)
                    (c = b.getClosest()),
                        p
                            ? ((k = p.minPointOffset), (n = p.pointRangePadding))
            ...
            setTickInterval: function (b) {
                ...
                r = I(g.userMax, c.max);
                t
                    ? ((g.linkedParent = d[g.coll][c.linkedTo]), (d = g.linkedParent.getExtremes()), (g.min = I(d.min, d.dataMin)), (g.max = I(d.max, d.dataMax)), c.type !== g.linkedParent.options.type && a.error(11, 1))
                    : (!w && y(H) && (g.dataMin >= H ? ((q = H), (G = 0)) : g.dataMax <= H && ((M = H), (h = 0))), (g.min = I(m, q, g.dataMin)), (g.max = I(r, M, g.dataMax)));
                ...
                g.tickInterval =
                    g.min === g.max || void 0 === g.min || void 0 === g.max
                        ? 1
                        : t && !x && z === g.linkedParent.options.tickPixelInterval
                        ? (x = g.linkedParent.tickInterval)
                        : I(x, this.tickAmount ? (g.max - g.min) / Math.max(this.tickAmount - 1, 1) : void 0, F ? 1 : ((g.max - g.min) * z) / Math.max(g.len, z));
                B &&
                    !b &&
                ...
                u || n || x || (g.tickInterval = L(g.tickInterval, null, k(g.tickInterval), I(c.allowDecimals, !(0.5 < g.tickInterval && 5 > g.tickInterval && 1e3 < g.max && 9999 > g.max)), !!this.tickAmount));
            ...
            setTickPositions: function () {
                ...
                this.isLinked || (this.single && 2 > b.length && ((this.min -= 0.5), (this.max += 0.5)), d || c || this.adjustTickAmount());
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks ||
                    ...
                    !1 === d.endOnTick ||
                    this.isLog ||
                    e(this.chart[this.coll], function (g) {
                        var d = g.options,
            ...
            zoom: function (a, b) {
                ...
                if (a !== this.min || b !== this.max)
                    this.allowZoomOutside || (y(g) && (a < k && (a = k), a > c && (a = c)), y(d) && (b < k && (b = k), b > c && (b = c))),
            ...
            getExtremes: function () {
                var a = this.isLog;
                return { min: a ? f(this.lin2log(this.min)) : this.min, max: a ? f(this.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
            },
            ...
            unsquish: function () {
                ...
                b
                    ? (t = !a.staggerLines && !a.step && (y(p) ? [p] : k < I(a.autoRotationLimit, 80) && a.autoRotation)) &&
                      e(t, function (a) {
                          var b;
                          if (a === p || (a && -90 <= a && 90 >= a)) (u = h(Math.abs(l.h / Math.sin(q * a)))), (b = u + Math.abs(a / 360)), b < B && ((B = b), (n = a), (c = u));
                      })
                    : a.step || (c = h(l.h));
                this.autoRotation = t;
            ...
            getSlotWidth: function () {
                var a = this.chart,
                    ...
                    k = a.margin[3];
                return (b && 2 > (d.step || 0) && !d.rotation && ((this.staggerLines || 1) * this.len) / c) || (!b && ((d.style && parseInt(d.style.width, 10)) || (k && k - a.spacing[3]) || 0.33 * a.chartWidth));
            },
            renderUnsquish: function () {
                ...
                if (this.autoRotation) x > u && x > f.h ? (B.rotation = this.labelRotation) : (this.labelRotation = 0);
                    ...
                    for (G = "clip", u = d.length; !p && u--; )
                        if (((z = d[u]), (z = c[z].label)))
                            z.styles && "ellipsis" === z.styles.textOverflow ? z.css({ textOverflow: "clip" }) : z.textPxLength > l && z.css({ width: l + "px" }),
                                z.getBBox().height > this.len / d.length - (f.h - f.f) && (z.specificTextOverflow = "ellipsis");
                B.rotation && ((h = x > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : x), t || (G = "ellipsis"));
                ...
                e(d, function (a) {
                    ...
                    b &&
                        (b.attr(B),
                        h && !g && "nowrap" !== n.whiteSpace && (h < b.textPxLength || "SPAN" === b.element.tagName)
                            ? ((d.width = h), t || (d.textOverflow = b.specificTextOverflow || G), b.css(d))
                            : b.styles && b.styles.width && !d.width && !g && b.css({ width: null }),
            ...
            addTitle: function (a) {
                var b = this.chart.renderer,
                    ...
                    k;
                this.axisTitle ||
                    ((k = c.textAlign) || (k = (g ? { low: "left", middle: "center", high: "right" } : { low: d ? "right" : "left", middle: "center", high: d ? "left" : "right" })[c.align]),
                    (this.axisTitle = b
                        .text(c.text, 0, 0, c.useHTML)
                        .attr({ zIndex: 7, rotation: c.rotation || 0, align: k })
            ...
            getOffset: function () {
                ...
                a.axisGroup ||
                    ((a.gridGroup = d
                        ...
                        .addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (M || ""))
                        .add(r)),
                    (a.axisGroup = d
                        .g("axis")
                        .attr({ zIndex: c.zIndex || 2 })
                        .addClass("highcharts-" + this.coll.toLowerCase() + " " + (M || ""))
                        .add(r)),
                    (a.labelGroup = d
                        .g("axis-labels")
                        .attr({ zIndex: F.zIndex || 7 })
                        .addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (M || ""))
                        .add(r)));
                f || a.isLinked
                    ? (e(k, function (b, g) {
                          a.generateTick(b, g);
                      ...
                      a.renderUnsquish(),
                      (a.reserveSpaceDefault = 0 === u || 2 === u || { 1: "left", 3: "right" }[u] === a.labelAlign),
                      I(F.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
                          e(k, function (a) {
            ...
            getTitlePosition: function () {
                var a = this.horiz,
                    ...
                    c = { low: n + (a ? 0 : c), middle: n + c / 2, high: n + (a ? c : 0) }[k.align],
                    b = (a ? d + this.height : b) + (a ? 1 : -1) * (e ? -1 : 1) * this.axisTitleMargin + [-B, B, f.f, -B][this.side];
                return { x: a ? c + l : b + (e ? this.width : 0) + p + l, y: a ? b + u - (e ? this.height : 0) + p : c + u };
            },
            ...
            renderTick: function (a, b) {
                ...
                if (!d || (a >= this.min && a <= this.max)) g[a] || (g[a] = new M(this, a)), c && g[a].isNew && g[a].render(b, !0, 0.1), g[a].render(b);
            },
            render: function () {
                var b = this,
                    d = b.chart,
                ...
                if (b.hasData() || n)
                    b.minorTickInterval &&
                        !b.categories &&
                        e(b.getMinorTickPositions(), function (a) {
                            b.renderMinorTick(a);
                        }),
                        u.length &&
                            (e(u, function (a, d) {
                        ...
                        H &&
                            e(u, function (c, g) {
                                ...
                                0 === g % 2 &&
                                    c < b.max &&
                                    r <= b.max + (d.polar ? -F : F) &&
                                    (G[c] || (G[c] = new a.PlotLineOrBand(b)), (q = c + F), (G[c].options = { from: k ? b.lin2log(q) : q, to: k ? b.lin2log(r) : r, color: H }), G[c].render(), (G[c].isActive = !0));
                            }),
                        b._addedPlotLB ||
                            (e((c.plotLines || []).concat(c.plotBands || []), function (a) {
                ...
                w && (w[w.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(w.strokeWidth()) }), (w.isPlaced = !0), w[I ? "show" : "hide"](!0));
            ...
            drawCrosshair: function (a, b) {
                ...
                if (this.crosshair && !1 !== (y(b) || !g)) {
                    ...
                    n ||
                        ((this.cross = n = this.chart.renderer
                            .path()
                            .addClass("highcharts-crosshair highcharts-crosshair-" + (g ? "category " : "thin ") + c.className)
                            .attr({ zIndex: I(c.zIndex, 2) })
                            .add()),
                        n.attr({ stroke: c.color || (g ? h("#ccd6eb").setOpacity(0.25).get() : "#cccccc"), "stroke-width": I(c.width, 1) }).css({ "pointer-events": "none" }),
                        c.dashStyle && n.attr({ dashstyle: c.dashStyle }));
                    n.show().attr({ d: d });
                    g && !c.width && n.attr({ "stroke-width": this.transA });
                    this.cross.e = a;
    ...
    (function (a) {
        ...
        C.prototype.normalizeTimeTickInterval = function (a, f) {
            ...
            return { unitRange: y, count: a, unitName: f[0] };
        };
    })(K);
    (function (a) {
        var C = a.Axis,
        ...
        C.prototype.getLogTickPositions = function (a, r, y, q) {
            ...
            if (0.5 <= a) (a = Math.round(a)), (c = this.getLinearTickPositions(a, r, y));
            else if (0.08 <= a)
                for (var e = Math.floor(r), l, z, k, d, b, f = 0.3 < a ? [1, 2, 4] : 0.15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < y + 1 && !b; e++)
                    for (z = f.length, l = 0; l < z && !b; l++) (k = this.log2lin(this.lin2log(e) * f[l])), k > r && (!q || d <= y) && void 0 !== d && c.push(d), d > y && (b = !0), (d = k);
            else
                (r = this.lin2log(r)),
                    (y = this.lin2log(y)),
    ...
    (function (a, C) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var f = this,
                    ...
                    n = q(l.zIndex, 0),
                    G = l.events,
                    x = { class: "highcharts-plot-" + (p ? "band " : "line ") + (l.className || "") },
                    B = {},
                    M = e.chart.renderer,
                    F = p ? "bands" : "lines";
                ...
                B.zIndex = n;
                F += "-" + n;
                (I = e.plotLinesAndBandsGroups[F]) ||
                    (e.plotLinesAndBandsGroups[F] = I = M.g("plot-" + F)
                        .attr(B)
                        .add());
                ...
                r && x && x.length
                    ...
                    : t && (x ? (t.show(), t.animate({ d: x })) : (t.hide(), k && (f.label = k = k.destroy())));
                h && m(h.text) && x && x.length && 0 < e.width && 0 < e.height && !x.isFlat
                    ? ((h = y({ align: c && p && "center", x: c ? !p && 4 : 10, verticalAlign: !c && p && "middle", y: c ? (p ? 16 : 10) : p ? 6 : -4, rotation: c && !p && 90 }, h)), this.renderLabel(h, x, p, n))
                    : k && k.hide();
                return f;
            },
            renderLabel: function (a, e, c, l) {
                ...
                f ||
                    ((f = { align: a.textAlign || a.align, rotation: a.rotation, class: "highcharts-plot-" + (c ? "band" : "line") + "-label " + (a.className || "") }),
                    (f.zIndex = l),
                ...
                c = E(l);
                k = E(e);
                f.align(a, !1, { x: c, y: k, width: D(l) - c, height: D(e) - k });
                f.show();
            },
            destroy: function () {
        ...
        a.extend(C.prototype, {
            getPlotBandPath: function (a, e) {
                ...
                if (l && c)
                    for (a && ((b = l.toString() === c.toString()), (d = 0)), a = 0; a < l.length; a += 6)
                        k && c[a + 1] === l[a + 1] ? ((c[a + 1] += d), (c[a + 4] += d)) : k || c[a + 2] !== l[a + 2] || ((c[a + 2] += d), (c[a + 5] += d)),
            ...
            removePlotBandOrLine: function (a) {
                for (var e = this.plotLinesAndBands, c = this.options, l = this.userOptions, h = e.length; h--; ) e[h].id === a && e[h].destroy();
    ...
    (function (a) {
        ...
        a.Tooltip.prototype = {
            ...
            getLabel: function () {
                ...
                this.label ||
                    (this.outside &&
                        ...
                        a.css(f, { position: "absolute", top: "1px", pointerEvents: e.style && e.style.pointerEvents }),
                        a.doc.body.appendChild(f),
                        (this.renderer = c = new a.Renderer(f, 0, 0))),
                    this.split
                        ? (this.label = c.g("tooltip"))
                        : ((this.label = c.label("", 0, 0, e.shape || "callout", null, null, e.useHTML, null, "tooltip").attr({ padding: e.padding, r: e.borderRadius })),
                          this.label.attr({ fill: e.backgroundColor, "stroke-width": e.borderWidth }).css(e.style).shadow(e.shadow)),
                    this.outside &&
                        (this.label.attr({ x: this.distance, y: this.distance }),
            ...
            move: function (c, e, f, k) {
                ...
                E(b, { x: u ? (2 * b.x + c) / 3 : c, y: u ? (b.y + e) / 2 : e, anchorX: p ? void 0 : u ? (2 * b.anchorX + f) / 3 : f, anchorY: p ? void 0 : u ? (b.anchorY + k) / 2 : k });
                d.getLabel().attr(b);
                u &&
                    (a.clearTimeout(this.tooltipTimeout),
            ...
            getAnchor: function (a, e) {
                var c = this.chart,
                    ...
                    h;
                a = q(a);
                (this.followPointer && e) || (k.followTouchMove && e && "touchmove" === e.type)
                    ? (void 0 === e.chartX && (e = k.normalize(e)), (a = [e.chartX - c.plotLeft, e.chartY - b]))
                    : a[0].tooltipPos
                    ? (a = a[0].tooltipPos)
                    : (D(a, function (a) {
                          t = a.series.yAxis;
            ...
            refresh: function (c, e) {
                ...
                k.enabled &&
                    ...
                    (e = u[0]),
                    (d = u[1]),
                    !p || (b.series && b.series.noSharedTooltip)
                        ? (p = b.getLabelConfig())
                        : (D(b, function (a) {
                              a.setState("hover");
                              l.push(a.getLabelConfig());
                          }),
                          (p = { x: b[0].category, y: b[0].y }),
                          (p.points = l),
                          (b = b[0])),
                    (this.len = l.length),
                    (p = f.call(p, this)),
                    ...
                    !1 === p
                        ? this.hide()
                        : ((f = this.getLabel()),
                          this.isHidden && f.attr({ opacity: 1 }).show(),
                          this.split
                              ? this.renderSplit(p, q(c))
                              : (k.style.width || f.css({ width: this.chart.spacingBox.width }),
                                f.attr({ text: p && p.join ? p.join("") : p }),
                                f.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + y(b.colorIndex, t.colorIndex)),
                                f.attr({ stroke: k.borderColor || b.color || t.color || "#666666" }),
                                this.updatePosition({ plotX: e, plotY: d, negative: b.negative, ttBelow: b.ttBelow, h: u[2] || 0 })),
                          (this.isHidden = !1)));
            },
                    ...
                    if (!1 !== a) {
                        ...
                        n ||
                            (h.tt = n = b
                                ...
                                .addClass("highcharts-tooltip-box " + B)
                                .attr({ padding: p.padding, r: p.borderRadius, fill: p.backgroundColor, stroke: p.borderColor || c.color || G.color || "#333333", "stroke-width": p.borderWidth })
                                .add(t));
                        n.isActive = !0;
                        n.attr({ text: a });
                        ...
                        a -= d.plotTop;
                        k.push({ target: c.isHeader ? d.plotHeight + l : a, rank: c.isHeader ? 1 : 0, size: h.tt.getBBox().height + 1, point: c, x: G, tt: n });
                    }
                });
                this.cleanSplit();
            ...
            tooltipFooterHeaderFormatter: function (a, e) {
                ...
                f &&
                    d &&
                    D((a.point && a.point.tooltipDateKeys) || ["key"], function (a) {
                        p = p.replace("{point." + a + "}", "{point." + a + ":" + d + "}");
                    });
                return m(p, { point: a, series: c }, this.chart.time);
            },
    ...
    (function (a) {
        ...
        a.Pointer.prototype = {
            ...
            normalize: function (a, d) {
                ...
                return y(a, { chartX: Math.round(b.pageX - d.left), chartY: Math.round(b.pageY - d.top) });
            },
            ...
            getChartCoordinatesFromPoint: function (a, d) {
                var b = a.series,
                    ...
                    e = a.shapeArgs;
                if (c && b) return d ? { chartX: c.len + c.pos - k, chartY: b.len + b.pos - a.plotY } : { chartX: k + c.pos, chartY: a.plotY + b.pos };
            ...
            getHoverData: function (b, d, k, e, f, h, l) {
                ...
                p &&
                    (f && !d.noSharedTooltip
                        ...
                        : n.push(p));
                return { hoverPoint: p, hoverSeries: d, hoverPoints: n };
            },
            runPointActions: function (b, d) {
                var c = this.chart,
                    ...
                    l = this.getHoverData(f, l, c.series, !!d || (l && l.directTouch && this.isDirectTouch), e, b, { isBoosting: c.isBoosting }),
                    u,
                    f = l.hoverPoint;
                u = l.hoverPoints;
                l = l.hoverSeries;
                ...
                if (f && (f !== c.hoverPoint || (k && k.isHidden))) {
                    ...
                    c.hoverPoint = f;
                    k && k.refresh(e ? u : f, b);
                } else d && k && !k.isHidden && ((f = k.getAnchor([{}], b)), k.updatePosition({ plotX: f[0], plotY: f[1] }));
                this.unDocMouseMove ||
                    (this.unDocMouseMove = C(c.container.ownerDocument, "mousemove", function (b) {
            ...
            drag: function (a) {
                ...
                (F && F.touch) ||
                    ...
                    10 < this.hasDragged &&
                        ((z = b.isInsidePlot(g - l, v - n)),
                        b.hasCartesianSeries &&
                            (this.zoomX || this.zoomY) &&
                            z &&
                            !q &&
                            !F &&
                            (this.selectionMarker = F = b.renderer
                                .rect(l, n, e ? 1 : h, f ? 1 : B, 0)
                                .attr({ fill: d.selectionMarkerFill || m("#335cad").setOpacity(0.25).get(), class: "highcharts-selection-marker", zIndex: 7 })
                                .add()),
                        F && e && ((c -= g), F.attr({ width: Math.abs(c), x: (0 < c ? 0 : c) + g })),
                        F && f && ((c = k - v), F.attr({ height: Math.abs(c), y: (0 < c ? 0 : c) + v })),
            ...
            drop: function (a) {
                ...
                if (this.selectionMarker) {
                    ...
                    if (this.hasDragged || c)
                        r(d.axes, function (d) {
                            if (d.zoomEnabled && f(d.min) && (c || b[{ xAxis: "zoomX", yAxis: "zoomY" }[d.coll]])) {
                                var e = d.horiz,
                                    g = "touchend" === a.type ? d.minPixelPadding : 0,
                                    l = d.toValue((e ? x : z) + g),
                                    e = d.toValue((e ? x + n : z + G) - g);
                                k[d.coll].push({ axis: d, min: Math.min(l, e), max: Math.max(l, e) });
                                B = !0;
                            }
                        }),
                            B &&
                                w(d, "selection", k, function (a) {
                                    d.zoom(y(a, c ? { animation: !1 } : null));
                                });
                    e(d.index) && (this.selectionMarker = this.selectionMarker.destroy());
                    c && this.scaleGroups();
                }
                d && e(d.index) && (h(d.container, { cursor: d._cursor }), (d.cancelClick = 10 < this.hasDragged), (d.mouseIsDown = this.hasDragged = this.hasPinched = !1), (this.pinchDown = []));
            },
            ...
            onContainerClick: function (a) {
                ...
                b.cancelClick ||
                    (d && this.inClass(a.target, "highcharts-tracker")
                        ? (w(d.series, "click", y(a, { point: d })), b.hoverPoint && d.firePointEvent("click", a))
                        : (y(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - c, a.chartY - k) && w(b, "click", a)));
            },
    ...
    (function (a) {
        ...
        E(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function (a, f, h, m, e, c, l, z) {
                ...
                v ? ((M -= 0.8 * (M - l[d][0])), G || (g -= 0.8 * (g - l[d][1])), h()) : (l[d] = [M, g]);
                y || ((c[d] = r - q), (c[p] = t));
                c = y ? 1 / x : x;
                e[p] = t;
                e[d] = f;
            ...
            pinch: function (a) {
                ...
                "touchstart" === a.type
                    ? (D(e, function (a, b) {
                      ...
                      (r.res = !0))
                    : r.followTouchMove && 1 === c
                    ? this.runPointActions(r.normalize(a))
                    : w.length && (k || (r.selectionMarker = k = E({ destroy: h, touch: !0 }, q.plotBox)), r.pinchTranslate(w, e, d, k, u, l), (r.hasPinched = z), r.scaleGroups(d, u), r.res && ((r.res = !1), this.reset(!1, 0)));
            },
            touch: function (h, m) {
                var q = this.chart,
                    r,
                ...
                1 === h.touches.length
                    ? ((h = this.normalize(h)),
                      (e = q.isInsidePlot(h.chartX - q.plotLeft, h.chartY - q.plotTop)) && !q.openMenu
                          ? (m && this.runPointActions(h),
                            "touchmove" === h.type && ((m = this.pinchDown), (r = m[0] ? 4 <= Math.sqrt(Math.pow(m[0].chartX - h.chartX, 2) + Math.pow(m[0].chartY - h.chartY, 2)) : !1)),
                            f(r, !0) && this.pinch(h))
                          : m && this.reset())
                    : 2 === h.touches.length && this.pinch(h);
            },
    ...
    (function (a) {
        ...
        if (!a.hasTouch && (q.PointerEvent || q.MSPointerEvent)) {
            var e = {},
                ...
                z = function (c, d, b, e) {
                    ("touch" !== c.pointerType && c.pointerType !== c.MSPOINTER_TYPE_TOUCH) || !D[a.hoverChartIndex] || (e(c), (e = D[a.hoverChartIndex].pointer), e[d]({ type: b, target: c.currentTarget, preventDefault: f, touches: l() }));
                };
            h(r.prototype, {
            ...
            w(r.prototype, "init", function (a, d, b) {
                a.call(this, d, b);
                this.hasZoom && E(d.container, { "-ms-touch-action": "none", "touch-action": "none" });
            });
    ...
    (function (a) {
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function (a, d) {
                ...
                f(this, "afterColorizeItem", { item: a, visible: d });
            },
            ...
            positionItem: function (a) {
                var d = this.options,
                    ...
                    c = c[1],
                    e = a.checkbox;
                if ((a = a.legendGroup) && a.element) a[m(a.translateY) ? "animate" : "attr"]({ translateX: d ? k : this.legendWidth - k - 2 * b - 4, translateY: c });
                e && ((e.x = k), (e.y = c));
            },
                ...
                a &&
                    ...
                    h(
                        ...
                        function (d) {
                            var k = d.checkbox,
                                f;
                            k && ((f = c + e + k.y + (this.scrollOffset || 0) + 3), D(k, { left: a.translateX + d.checkboxOffset + k.x - 20 + "px", top: f + "px", display: f > c - 6 && f < c + b - 6 ? "" : "none" }));
                        },
                        this
                    ));
            },
            ...
            renderItem: function (a) {
                ...
                n ||
                    ((a.legendGroup = b
                        .g("legend-item")
                        .addClass("highcharts-" + B.type + "-series highcharts-color-" + a.colorIndex + (g ? " " + g : "") + (G ? " highcharts-series-" + a.index : ""))
                        .attr({ zIndex: 1 })
                        .add(this.scrollGroup)),
                    (a.legendItem = n = b
                        .text("", z ? k + f : -f, this.baseline || 0, F)
                        .css(q(a.visible ? l : h))
                        .attr({ align: z ? "left" : "right", zIndex: 2 })
                        .add(a.legendGroup)),
                    this.baseline || ((k = l.fontSize), (this.fontMetrics = b.fontMetrics(k, n)), (this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop), n.attr("y", this.baseline)),
                ...
                l.width || n.css({ width: (e.itemWidth || e.width || c.spacingBox.width) - x });
                this.setText(a);
                c = n.getBBox();
            ...
            getAllItems: function () {
                ...
                f(this, "afterGetAllItems", { allItems: a });
                return a;
            },
            ...
            adjustMargins: function (a, c) {
                var b = this.chart,
                    ...
                    e = this.getAlignment();
                e &&
                    h([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (k, f) {
                        k.test(e) &&
                            !m(a[f]) &&
                            (b[y[f]] = Math.max(
                                b[y[f]],
                                b.legend[(f + 1) % 2 ? "legendHeight" : "legendWidth"] +
                                    ...
                                    w(d.margin, 12) +
                                    c[f] +
                                    (0 === f && void 0 !== b.options.title.margin ? b.titleOffset + b.options.title.margin : 0)
                            ));
                    });
            },
            ...
            render: function () {
                ...
                b || ((this.group = b = d.g("legend").attr({ zIndex: 7 }).add()), (this.contentGroup = d.g().attr({ zIndex: 1 }).add(b)), (this.scrollGroup = d.g().add(this.contentGroup)));
                this.renderTitle();
                e = this.getAllItems();
                c(e, function (a, b) {
                ...
                l += x;
                t || ((this.box = t = d.rect().addClass("highcharts-legend-box").attr({ r: z.borderRadius }).add(b)), (t.isNew = !0));
                t.attr({ stroke: z.borderColor, "stroke-width": z.borderWidth || 0, fill: z.backgroundColor || "none" }).shadow(z.shadow);
                0 < e && 0 < l && (t[t.isNew ? "attr" : "animate"](t.crisp.call({}, { x: 0, y: 0, width: e, height: l }, t.strokeWidth())), (t.isNew = !1));
                t[f ? "show" : "hide"]();
                this.legendWidth = e;
                this.legendHeight = l;
                f &&
                    ((d = a.spacingBox),
                    /(lth|ct|rth)/.test(this.getAlignment()) && (d = q(d, { y: d.y + a.titleOffset + a.options.title.margin })),
                    b.align(q(z, { width: e, height: l, verticalAlign: this.proximate ? "top" : z.verticalAlign }), !0, d));
            ...
            handleOverflow: function (a) {
                var c = this,
                    ...
                    g = this.allItems,
                    v = function (a) {
                        "number" === typeof a ? x.attr({ height: a }) : x && ((c.clipRect = x.destroy()), c.contentGroup.clip());
                ...
                q.length = 0;
                a > b && !1 !== m.enabled
                    ? ((this.clipHeight = z = Math.max(b - 20 - this.titleHeight - l, 0)),
                      ...
                      h(g, function (a, b) {
                          var c = a._legendItemPos[1],
                              ...
                              e = q.length;
                          if (!e || (c - q[e - 1] > z && (F || c) !== q[e - 1])) q.push(F || c), e++;
                          a.pageIx = e - 1;
                          F && (g[b - 1].pageIx = e - 1);
                          b === g.length - 1 && c + d - q[e - 1] > z && (q.push(c), (a.pageIx = e));
                          c !== F && (F = c);
                      }),
                      x || ((x = c.clipRect = e.clipRect(0, l, 9999, 0)), c.contentGroup.clip(x)),
                      v(z),
                      B ||
                          ((this.nav = B = e.g().attr({ zIndex: 1 }).add(this.group)),
                          (this.up = e
                      ...
                      c.scroll(0),
                      (a = b))
                    : B && (v(), (this.nav = B.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
                return a;
            },
            scroll: function (a, c) {
                var b = this.pages,
                ...
                a > d && (a = d);
                0 < a &&
                    (void 0 !== c && e(c, this.chart),
                    this.nav.attr({ translateX: h, translateY: k + this.padding + 7 + this.titleHeight, visibility: "visible" }),
                    this.up.attr({ class: 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }),
                    l.attr({ text: a + "/" + d }),
                    this.down.attr({ x: 18 + this.pager.getBBox().width, class: a === d ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }),
                    this.up.attr({ fill: 1 === a ? f.inactiveColor : f.activeColor }).css({ cursor: 1 === a ? "default" : "pointer" }),
                    this.down.attr({ fill: a === d ? f.inactiveColor : f.activeColor }).css({ cursor: a === d ? "default" : "pointer" }),
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, c) {
                ...
                c.legendSymbol = this.chart.renderer
                    .rect(d ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, d ? b : a.symbolWidth, b, w(a.options.symbolRadius, b / 2))
            ...
            drawLineMarker: function (a) {
                ...
                var z;
                z = { "stroke-width": c.lineWidth || 0 };
                c.dashStyle && (z.dashstyle = c.dashStyle);
                this.legendLine = l.path(["M", 0, a, "L", e, a]).addClass("highcharts-graph").attr(z).add(h);
                b &&
                    !1 !== b.enabled &&
                    e &&
                    ((c = Math.min(w(b.radius, f), f)),
                    0 === this.symbol.indexOf("url") && ((b = q(b, { width: k, height: k })), (c = 0)),
                    (this.legendSymbol = b = l
                        .symbol(this.symbol, e / 2 - c, a - c, 2 * c, 2 * c, b)
                        .addClass("highcharts-point")
                        .add(h)),
                    (b.isMarker = !0));
            },
        };
        (/Trident\/7\.0/.test(l.navigator.userAgent) || r) &&
            z(a.Legend.prototype, "positionItem", function (a, c) {
                var b = this,
                    d = function () {
    ...
    (function (a) {
        ...
        z(Q.prototype, {
            ...
            redraw: function (b) {
                ...
                if (h) for (b = g.length; b--; ) (v = g[b]), v.options.stacking && (v.isDirty = !0);
                l(g, function (a) {
            ...
            setTitle: function (a, b, c) {
                var d = this,
                    g = d.options,
                    e;
                e = g.title = x({ style: { color: "#333333", fontSize: g.isStock ? "16px" : "18px" } }, g.title, a);
                g = g.subtitle = x({ style: { color: "#666666" } }, g.subtitle, b);
                l(
                    [
                        ["title", a, e],
                        ["subtitle", b, g],
                    ...
                    function (a, b) {
                        ...
                        a &&
                            ...
                            ((d[c] = d.renderer
                                ...
                                .attr({ align: a.align, class: "highcharts-" + c, zIndex: a.zIndex || 4 })
                                .add()),
                ...
                l(
                    ...
                    function (a) {
                        ...
                        c &&
                            ...
                            c.css({ width: (e.width || g.width + e.widthAdjust) + "px" }).align(z({ y: a + n }, e), !1, "spacingBox"),
            ...
            temporaryDisplay: function (b) {
                var c = this.renderTo;
                if (b) for (; c && c.style; ) c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (h.body.removeChild(c), (c.hcOrigDetached = !1)), (c = c.parentNode);
                else
                    for (; c && c.style; ) {
                        h.body.contains(c) || c.parentNode || ((c.hcOrigDetached = !0), h.body.appendChild(c));
                        if ("none" === a.getStyle(c, "display", !1) || c.hcOricDetached)
                            (c.hcOrigStyle = { display: c.style.display, height: c.style.height, overflow: c.style.overflow }),
            ...
            getContainer: function () {
                ...
                e = this.chartWidth;
                n = this.chartHeight;
                k = z({ position: "relative", overflow: "hidden", width: e + "px", height: n + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" }, g.style);
                this.container = b = r("div", { id: f }, k, b);
            ...
            setSize: function (b, c, g) {
                ...
                n.getChartSize();
                b = k.globalAnimation;
                (b ? D : e)(n.container, { width: n.chartWidth + "px", height: n.chartHeight + "px" }, b);
                n.setChartSize(!0);
            ...
            setChartSize: function (a) {
                ...
                this.spacingBox = c.spacingBox = { x: k[3], y: k[0], width: g - k[3] - k[1], height: e - k[0] - k[2] };
                this.plotBox = c.plotBox = { x: h, y: B, width: G, height: v };
                g = 2 * Math.floor(this.plotBorderWidth / 2);
                b = Math.ceil(Math.max(g, f[3]) / 2);
                c = Math.ceil(Math.max(g, f[0]) / 2);
                this.clipBox = { x: b, y: c, width: Math.floor(this.plotSizeX - Math.max(g, f[1]) / 2 - b), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(g, f[2]) / 2 - c)) };
                a ||
            ...
            drawChartBox: function () {
                ...
                v = f + (a.shadow ? 8 : 0);
                h = { fill: h || "none" };
                if (f || e["stroke-width"]) (h.stroke = a.borderColor), (h["stroke-width"] = f);
                e.attr(h).shadow(a.shadow);
                e[q]({ x: v / 2, y: v / 2, width: c - v - (f % 2), height: g - v - (f % 2), r: a.borderRadius });
                q = "animate";
                n || ((q = "attr"), (this.plotBackground = n = b.rect().addClass("highcharts-plot-background").add()));
                n[q](F);
                n.attr({ fill: B || "none" }).shadow(a.plotShadow);
                G && (l ? l.animate(F) : (this.plotBGImage = b.image(G, p, t, z, x).add()));
                u ? u.animate({ width: m.width, height: m.height }) : (this.clipRect = b.clipRect(m));
                q = "animate";
                k || ((q = "attr"), (this.plotBorder = k = b.rect().addClass("highcharts-plot-border").attr({ zIndex: 1 }).add()));
                k.attr({ stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none" });
                k[q](k.crisp({ x: p, y: t, width: z, height: x }, -k.strokeWidth()));
                this.isDirtyBox = !1;
    ...
    (function (a) {
        ...
        C(D, "afterSetChartSize", function (m) {
            ...
            (h = h && h.minWidth) &&
                ...
                (this.scrollablePixels = h = Math.max(0, h - this.chartWidth)) &&
                ((this.plotWidth += h),
                (this.clipBox.width += h),
                m.skipAxes ||
                    E(this.axes, function (f) {
                        1 === f.side
        ...
        D.prototype.applyFixed = function () {
            var m = this.container,
                ...
                r = !this.fixedDiv;
            r &&
                ((this.fixedDiv = a.createElement("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: 2 }, null, !0)),
            ...
            this.renderer.boxWrapper.attr({ width: f, height: this.chartHeight, viewBox: [0, 0, f, this.chartHeight].join(" ") });
        ...
        a.Point.prototype = {
            init: function (a, c, f) {
                ...
                a.options.colorByPoint
                    ? ((c = a.options.colors || a.chart.options.colors), (this.color = this.color || c[a.colorCounter]), (c = c.length), (f = a.colorCounter), a.colorCounter++, a.colorCounter === c && (a.colorCounter = 0))
                    : (f = a.colorIndex);
            ...
            optionsToObject: function (e) {
                ...
                if (y(e) || null === e) c[k[0]] = e;
                    ...
                    for (!h && e.length > d && ((f = typeof e[0]), "string" === f ? (c.name = e[0]) : "number" === f && (c.x = e[0]), b++); u < d; )
            ...
            destroyElements: function () {
                for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], c, f = 6; f--; ) (c = a[f]), this[c] && (this[c] = this[c].destroy());
            },
            ...
            tooltipFormatter: function (a) {
                ...
                return f(a, { point: this, series: this.series }, c.chart.time);
            },
        ...
        a.Series = a.seriesType(
            ...
            },
            {
                ...
                setOptions: function (a) {
                    ...
                    a.length && y(a[a.length - 1].value) && a.push({ color: this.color, fillColor: this.fillColor });
                    c(this, "afterSetOptions", { options: d });
                    return d;
                },
                getName: function () {
                ...
                updateData: function (b) {
                    ...
                    if (f) for (b = d.length; b--; ) (g = d[b]), g.touched || g.remove(!1), (g.touched = !1);
                ...
                setData: function (b, c, e, f) {
                    ...
                    if (!y) {
                        ...
                        if (u && l > u) {
                            for (e = 0; null === t && e < l; ) (t = b[e]), e++;
                            if (k(t)) for (e = 0; e < l; e++) (m[e] = this.autoIncrement()), (r[e] = b[e]);
                            else if (z(t))
                                if (w) for (e = 0; e < l; e++) (t = b[e]), (m[e] = t[0]), (r[e] = t.slice(1, w + 1));
                                else for (e = 0; e < l; e++) (t = b[e]), (m[e] = t[0]), (r[e] = t[1]);
                            else a.error(12);
                        } else for (e = 0; e < l; e++) void 0 !== b[e] && ((t = { series: n }), n.pointClass.prototype.applyOptions.apply(t, [b[e]]), n.updateParallelArrays(t, e));
                ...
                processData: function (b) {
                    ...
                    t &&
                        ...
                        (c[e - 1] < m || c[0] > z ? ((c = []), (d = [])) : this.yData && (c[0] < m || c[e - 1] > z) && ((f = this.cropData(this.xData, this.yData, m, z)), (c = f.xData), (d = f.yData), (f = f.start), (g = !0)));
                    for (h = c.length || 1; --h; ) (e = x ? l(c[h]) - l(c[h - 1]) : c[h] - c[h - 1]), 0 < e && (void 0 === k || e < k) ? (k = e) : 0 > e && u && (a.error(15), (u = !1));
                    this.cropped = g;
                    this.cropStart = f;
                ...
                generatePoints: function () {
                    ...
                    this.options.keys = a;
                    if (c && (k !== (d = c.length) || p)) for (m = 0; m < d; m++) m !== h || p || (m += k), c[m] && (c[m].destroyElements(), (c[m].plotX = void 0));
                    this.data = c;
                    this.points = u;
                },
                getExtremes: function (a) {
                    ...
                    for (x = 0; x < d; x++)
                        if (
                            ...
                            if ((h = t.length)) for (; h--; ) "number" === typeof t[h] && (e[g++] = t[h]);
                            else e[g++] = t;
                    this.dataMin = m(e);
                    this.dataMax = E(e);
                },
                ...
                setClip: function (a) {
                    var b = this.chart,
                        ...
                        h = b[k + "m"];
                    n ||
                        (a && ((f.width = 0), e && (f.x = b.plotSizeX), (b[k + "m"] = h = d.clipRect(e ? b.plotSizeX + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight))),
                        (b[k] = n = d.clipRect(f)),
                        (n.count = { length: 0 }));
                ...
                animate: function (a) {
                    var b = this.chart,
                        ...
                        d;
                    a ? this.setClip(c) : ((d = this.sharedClipKey), (a = b[d]) && a.animate({ width: b.plotSizeX, x: 0 }, c), b[d + "m"] && b[d + "m"].animate({ width: b.plotSizeX + 99, x: 0 }, c), (this.animate = null));
                },
                ...
                pointAttribs: function (a, b) {
                    ...
                    b &&
                        ((c = c.states[b]), (b = (e.states && e.states[b]) || {}), (d = p(b.lineWidth, c.lineWidth, d + p(b.lineWidthPlus, c.lineWidthPlus, 0))), (a = b.fillColor || c.fillColor || a), (g = b.lineColor || c.lineColor || g));
                    ...
                    q(a, function (f, l) {
                        ...
                        f.isNull && !y(b) && 0 < l
                            ...
                            : (0 === l || h
                                  ? (l = ["M", f.plotX, f.plotY])
                                  : d.getPointSpline
                                  ? (l = d.getPointSpline(a, f, l))
                                  : g
                                  ? ((l = 1 === g ? ["L", x.plotX, t] : 2 === g ? ["L", (x.plotX + p) / 2, x.plotY, "L", (x.plotX + p) / 2, t] : ["L", p, x.plotY]), l.push("L", p, t))
                                  : (l = ["L", p, t]),
                              n.push(f.x),
                              g && (n.push(f.x), 2 === g && n.push(f.x)),
                              k.push.apply(k, l),
                              (h = !1));
                    });
                    k.xMap = n;
                ...
                drawGraph: function () {
                    ...
                    q(d, function (d, e) {
                        var g = d[0],
                            f = a[g];
                        f
                            ? ((f.endX = a.preventGraphAnimation ? null : c.xMap), f.animate({ d: c }))
                            : c.length &&
                              ((a[g] = a.chart.renderer.path(c).addClass(d[1]).attr({ zIndex: 1 }).add(a.group)),
                              (f = { stroke: d[2], "stroke-width": b.lineWidth, fill: (a.fillGraph && a.color) || "none" }),
                ...
                applyZones: function () {
                    ...
                    d.length &&
                        ...
                        q(d, function (d, n) {
                            ...
                            y = Math.min(e, g);
                            I = Math.max(e, g);
                            x.isXAxis ? ((k = { x: z ? I : y, y: 0, width: w, height: t }), r || (k.x = b.plotHeight - k.x)) : ((k = { x: 0, y: z ? I : y, width: t, height: w }), r && (k.y = b.plotWidth - k.y));
                            z && c.isVML && (k = x.isXAxis ? { x: 0, y: u ? y : I, height: k.width, width: b.chartWidth } : { x: k.y - b.plotLeft - b.spacingBox.x, y: 0, width: k.height, height: b.chartHeight });
                ...
                plotGroup: function (a, b, c, d, e) {
                    ...
                    g.addClass(
                        "highcharts-" +
                            ...
                            this.type +
                            "-series " +
                            (y(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") +
                    ...
                    function a(c, d, e) {
                        ...
                        if ((f = c && c.length))
                            return (
                                ...
                                (f = Math.floor(f / 2)),
                                { point: c[f], left: a(c.slice(0, f), d + 1, e), right: a(c.slice(f + 1), d + 1, e) }
                            );
                    }
    ...
    (function (a) {
        ...
        a.StackItem = function (a, c, f, h, k) {
            ...
            this.alignOptions = { align: c.align || (d ? (f ? "left" : "right") : "center"), verticalAlign: c.verticalAlign || (d ? "middle" : f ? "bottom" : "top"), y: q(c.y, d ? 4 : f ? 14 : -6), x: q(c.x, d ? (f ? -6 : 6) : 0) };
        ...
        a.StackItem.prototype = {
            ...
            render: function (a) {
                ...
                this.label ? this.label.attr({ text: f, visibility: "hidden" }) : (this.label = c.renderer.text(f, null, null, e.useHTML).css(e.style).attr({ align: this.textAlign, rotation: e.rotation, visibility: "hidden" }).add(a));
            ...
            getStackBox: function (a, c, f, h, k, d, b) {
                ...
                return { x: l ? (c ? h : h - d) : f, y: l ? a - f - k : c ? a - h - d : a - h, width: l ? d : k, height: l ? k : d };
            },
        };
        ...
        C.prototype.renderStackTotals = function () {
            ...
            h || (this.stackTotalGroup = h = c.g("stack-labels").attr({ visibility: "visible", zIndex: 6 }).add());
            ...
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (F = 0; F < h; F++)
                    (g = e[F]),
                        ...
                        (B = x[B][g]),
                        null !== v
                            ? ((B.points[M] = B.points[this.index] = [q(B.cumulative, b)]),
                              m(B.cumulative) || (B.base = M),
                              (B.touched = w.stacksTouched),
                              0 < n.index && !1 === this.singleStacks && (B.points[M][0] = B.points[this.index + "," + g + ",0"][0]))
                            : (B.points[M] = B.points[this.index] = null),
                        "percent" === k
                            ? ((G = G ? p : r), t && x[G] && x[G][g] ? ((G = x[G][g]), (B.total = G.total = Math.max(G.total, B.total) + Math.abs(v) || 0)) : (B.total = E(B.total + (Math.abs(v) || 0))))
                            : (B.total = E(B.total + (v || 0))),
        ...
        w.prototype.modifyStacks = function () {
            ...
            a[d + "Stacker"] &&
                f([c, "-" + c], function (b) {
                    for (var c = m.length, e, f; c--; ) if (((e = m[c]), (k = a.getStackIndicator(k, e, a.index, b)), (f = (e = h[b] && h[b][e]) && e.points[k.key]))) a[d + "Stacker"](f, e, c);
                });
        };
        ...
        w.prototype.getStackIndicator = function (a, c, f, h) {
            !m(a) || a.x !== c || (h && a.key !== h) ? (a = { x: c, index: 0, key: h }) : a.index++;
    ...
    (function (a) {
        ...
        q(a.Chart.prototype, {
            addSeries: function (a, c, d) {
                ...
                a &&
                    ((c = b(c, !0)),
                    w(f, "addSeries", { options: a }, function () {
                        e = f.initSeries(a);
                        f.isDirtyLegend = !0;
                        f.linkSeries();
                        w(f, "afterAddSeries");
            ...
            addAxis: function (a, c, d, e) {
                var f = c ? "xAxis" : "yAxis",
                    h = this.options;
                a = k(a, { index: this[f].length, isX: c });
                c = new E(this, a);
                h[f] = L(h[f] || {});
                h[f].push(a);
                b(d, !0) && this.redraw(e);
            ...
            showLoading: function (a) {
                var b = this,
                    ...
                    e = c.loading,
                    f = function () {
                        d && h(d, { left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px" });
                    };
                d || ((b.loadingDiv = d = m("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, b.container)), (b.loadingSpan = m("span", { className: "highcharts-loading-inner" }, null, d)), C(b, "redraw", f));
                d.className = "highcharts-loading";
                b.loadingSpan.innerHTML = a || c.lang.loading;
                h(d, q(e.style, { zIndex: 10 }));
                h(b.loadingSpan, e.labelStyle);
                b.loadingShown || (h(d, { opacity: 0, display: "" }), D(d, { opacity: e.style.opacity || 0.5 }, { duration: e.showDuration || 0 }));
                b.loadingShown = !0;
                f();
            },
            ...
            update: function (a, h, l, p) {
                var n = this,
                    t = { title: "setTitle", subtitle: "setSubtitle" },
                    x = a.chart,
                    g,
                    m,
                    u = [];
                w(n, "update", { options: a });
                if (x) {
                    k(!0, n.options.chart, x);
                    "className" in x && n.setClassName(x.className);
                    "reflow" in x && n.setReflow(x.reflow);
                    if ("inverted" in x || "polar" in x || "type" in x) n.propFromSeries(), (g = !0);
                    "alignTicks" in x && (g = !0);
                    d(x, function (a, b) {
        ...
        q(u.prototype, {
            update: function (a, c, d, e) {
                function f() {
                    ...
                    l(a, !0) &&
                        (g && g.element && a && a.marker && void 0 !== a.marker.symbol && (k.graphic = g.destroy()),
                ...
                var k = this,
                    ...
                    t = h.options;
                c = b(c, !0);
                !1 === e ? f() : k.firePointEvent("update", { options: a }, f);
            },
            remove: function (a, b) {
        ...
        q(p.prototype, {
            ...
            removePoint: function (a, c, d) {
                var e = this,
                    ...
                    n = function () {
                        ...
                        e.updateParallelArrays(k || { series: e }, "splice", a, 1);
                        k && k.destroy();
                        e.isDirty = !0;
                        e.isDirtyData = !0;
                        c && g.redraw();
            ...
            update: function (c, d) {
                var f = this,
                    ...
                    z = f.finishedAnimating && { animation: !1 },
                ...
                if (A) c.data && this.setData(c.data, !1), c.name && this.setName(c.name, !1);
                else {
                    u = m.concat(u);
                    r(u, function (a) {
                        u[a] = f[a];
                    ...
                    c = k(l, z, { index: f.index, pointStart: b(l.pointStart, f.xData[0]) }, { data: f.options.data }, c);
                    f.remove(!1, null, !1);
            ...
            { softThreshold: !1, threshold: 0 },
            {
                ...
                getStackPoints: function (f) {
                    ...
                    if (this.options.stacking) {
                        for (p = 0; p < f.length; p++) (f[p].leftNull = f[p].rightNull = null), (l[f[p].x] = f[p]);
                        a.objectEach(c, function (a, b) {
                        ...
                        D(q, function (a, f) {
                            ...
                            if (l[a] && !l[a].isNull)
                                h.push(l[a]),
                                    D([-1, 1], function (e) {
                                        var k = 1 === e ? "rightNull" : "leftNull",
                                            h = 0,
                                            n = c[q[f + e]];
                                        if (n) for (p = z; 0 <= p && p < d; ) (t = n.points[p]), t || (p === z ? (l[a][k] = !0) : b[p] && (m = c[a].points[p]) && (h -= m[1] - m[0])), (p += u);
                                ...
                                h.push({ isNull: !0, plotX: r.translate(a, 0, 0, 0, 1), x: a, plotY: k, yBottom: k });
                            }
                        });
                    }
                    return h;
                ...
                getGraphPath: function (a) {
                    var f = h.prototype.getGraphPath,
                        ...
                        L = function (c, f, h) {
                            ...
                            void 0 !== t && (k.push({ plotX: b, plotY: null === t ? H : e.getThreshold(t), isNull: l, isCliff: !0 }), z.push({ plotX: b, plotY: null === m ? H : e.getThreshold(m), doCurve: !1 }));
                        };
                    a = a || this.points;
                    r && (a = this.getStackPoints(a));
                    for (c = 0; c < a.length; c++)
                        if (((l = a[c].isNull), (b = m(a[c].rectPlotX, a[c].plotX)), (t = m(a[c].yBottom, H)), !l || q))
                            q || L(c, c - 1, "left"), (l && !r && q) || (k.push(a[c]), z.push({ x: c, plotX: b, plotY: t })), q || L(c, c + 1, "right");
                    c = f.call(this, k, !0, !0);
                    z.reversed = !0;
                    l = f.call(this, z, !0, !0);
                    l.length && (l[0] = "L");
                ...
                drawGraph: function () {
                    ...
                    D(w, function (e) {
                        var c = e[0],
                            h = a[c];
                        h
                            ? ((h.endX = a.preventGraphAnimation ? null : f.xMap), h.animate({ d: f }))
                            : ((h = a[c] = a.chart.renderer
                                  .path(f)
                                  .addClass(e[1])
                                  .attr({ fill: m(e[3], C(e[2]).setOpacity(m(q.fillOpacity, 0.75)).get()), zIndex: 0 })
                                  .add(a.group)),
                              (h.isArea = !0));
                        h.startX = f.xMap;
    ...
    (function (a) {
        var C = a.seriesTypes.area.prototype,
            D = a.seriesType;
        D("areaspline", "spline", a.defaultPlotOptions.area, { getStackPoints: C.getStackPoints, getGraphPath: C.getGraphPath, drawGraph: C.drawGraph, drawLegendSymbol: a.LegendSymbolMixin.drawRectangle });
    })(K);
    (function (a) {
        var C = a.animObject,
            D = a.color,
        ...
        q(
            ...
            },
            {
                ...
                getColumnMetrics: function () {
                    ...
                    !1 === c.grouping
                        ...
                        : E(a.chart.series, function (c) {
                              ...
                              c.type !== a.type ||
                                  ...
                                  h.len !== f.len ||
                                  h.pos !== f.pos ||
                                  (e.stacking ? ((d = c.stackKey), void 0 === b[d] && (b[d] = m++), (k = b[d])) : !1 !== e.grouping && (k = m++), (c.columnIndex = k));
                          });
                    ...
                    a.columnMetrics = { width: c, offset: (t - c) / 2 + (q + ((a.columnIndex || 0) + (k ? 1 : 0)) * t - p / 2) * (k ? -1 : 1) };
                ...
                crispCol: function (a, c, f, h) {
                    ...
                    h = Math.round(c + h) + d;
                    b = 0.5 >= Math.abs(c) && 0.5 < h;
                    c = Math.round(c) + d;
                    h -= c;
                    b && h && (--c, (h += 1));
                    return { x: a, y: c, width: f, height: h };
                },
                translate: function () {
                    var a = this,
                        c = a.chart,
                ...
                pointAttribs: function (a, c) {
                    ...
                    c &&
                        ((a = f(e.states[c], (a.options.states && a.options.states[c]) || {})),
                        (c = a.brightness),
                        (b = a.color || (void 0 !== c && D(b).brighten(a.brightness).get()) || b),
                        (m = a[h] || m),
                        (p = a[d] || p),
                        (k = a.dashStyle || k));
                    h = { fill: b, stroke: m, "stroke-width": p };
                    k && (h.dashstyle = k);
                    return h;
                },
                drawPoints: function () {
                    ...
                    E(a.points, function (b) {
                        ...
                        if (h(b.plotY) && null !== b.y) {
                            ...
                            l.borderRadius && e.attr({ r: l.borderRadius });
                ...
                animate: function (a) {
                    ...
                    w &&
                        (a
                            ? ((d.scaleY = 0.001), (a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(e.threshold)))), k ? (d.translateX = a - f.len) : (d.translateY = a), c.group.attr(d))
                            : ((h = c.group.attr(b)),
                              c.group.animate(
                                  { scaleY: 1 },
        ...
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options,
                    ...
                    e,
                    c;
                for (e = 0; 4 > e; ++e) (c = q[e]), (a = 2 > e || (2 === e && /%$/.test(c))), (q[e] = m(c, [y, f, w, q[2]][e]) + (a ? r : 0));
                q[3] > q[2] && (q[3] = q[2]);
                return q;
            },
            getStartAndEndRadians: function (a, f) {
                ...
                return { start: C * (a + -90), end: C * (f + -90) };
            },
        };
    })(K);
    (function (a) {
        ...
        c(
            ...
            },
            {
                ...
                animate: function (a) {
                    ...
                    a ||
                        (m(d, function (a) {
                            var d = a.graphic,
                                f = a.shapeArgs;
                            d && (d.attr({ r: a.startR || c.center[3] / 2, start: b, end: b }), d.animate({ r: f.r, start: f.start, end: f.end }, c.options.animation));
                        }),
                        (c.animate = null));
                },
                ...
                translate: function (a) {
                    ...
                    for (z = 0; z < y; z++) {
                        ...
                        l = x + c * m;
                        F.shapeType = "arc";
                        F.shapeArgs = { x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: Math.round(1e3 * h) / 1e3, end: Math.round(1e3 * l) / 1e3 };
                        t = (l + h) / 2;
                        t > 1.5 * Math.PI ? (t -= 2 * Math.PI) : t < -Math.PI / 2 && (t += 2 * Math.PI);
                        F.slicedTranslation = { translateX: Math.round(Math.cos(t) * b), translateY: Math.round(Math.sin(t) * b) };
                        l = (Math.cos(t) * a[2]) / 2;
                        n = (Math.sin(t) * a[2]) / 2;
                        F.tooltipPos = [a[0] + 0.7 * l, a[1] + 0.7 * n];
                        F.half = t < -Math.PI / 2 || t > Math.PI / 2 ? 1 : 0;
                        F.angle = t;
                        h = Math.min(e, F.labelDistance / 5);
                        F.labelPos = [
                            a[0] + l + Math.cos(t) * F.labelDistance,
                            a[1] + n + Math.sin(t) * F.labelDistance,
                            a[0] + l + Math.cos(t) * h,
                            a[1] + n + Math.sin(t) * h,
                            a[0] + l,
                            a[1] + n,
                            0 > F.labelDistance ? "center" : F.half ? "right" : "left",
                            t,
                        ];
                    }
                },
                ...
                drawPoints: function () {
                    ...
                    m(a.points, function (k) {
                        ...
                        if (k.isNull) b && (k.graphic = b.destroy());
                            ...
                            b ? b.setRadialReference(a.center).attr(f).animate(h(e, d)) : ((k.graphic = b = c[k.shapeType](e).setRadialReference(a.center).attr(d).add(a.group)), b.attr(f).attr({ "stroke-linejoin": "round" }).shadow(l, t));
                            b.attr({ visibility: k.visible ? "inherit" : "hidden" });
            ...
            },
            {
                ...
                setVisible: function (a, c) {
                    ...
                    c = q(c, e);
                    a !== d.visible &&
                        ((d.visible = d.options.visible = a = void 0 === a ? !d.visible : a),
    ...
    (function (a) {
        ...
        a.distribute = function (c, b, f) {
            ...
            if (q > n) {
                ...
                for (q = e = 0; q <= n; ) (q += c[e].size), e++;
                x = c.splice(e - 1, c.length);
            }
            k(c, d);
            for (
                c = r(c, function (a) {
                    return { size: a.size, targets: [a.target], align: w(a.align, 0.5) };
                });
                h;

            ) {
                for (e = c.length; e--; ) (h = c[e]), (q = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2), (h.pos = Math.min(Math.max(0, q - h.size * h.align), b - h.size));
                e = c.length;
                for (h = !1; e--; )
                    0 < e &&
                        c[e - 1].pos + c[e - 1].size > c[e].pos &&
                        ((c[e - 1].size += c[e].size), (c[e - 1].targets = c[e - 1].targets.concat(c[e].targets)), (c[e - 1].align = 0.5), c[e - 1].pos + c[e - 1].size > b && (c[e - 1].pos = b - c[e - 1].size), c.splice(e, 1), (h = !0));
            }
            l.push.apply(l, x);
            e = 0;
            z(c, function (c) {
                var d = 0;
                if (
                    z(c.targets, function () {
                        l[e].pos = c.pos + d;
                        if (Math.abs(l[e].pos - l[e].target) > f)
                            return (
                                m(l.slice(0, e + 1), function (a) {
                                    delete a.pos;
                                }),
                                (l.reducedLen = (l.reducedLen || b) - 0.1 * b),
                                l.reducedLen > 0.1 * b && a.distribute(l, b, f),
                                !0
                            );
                        d += l[e].size;
                        e++;
            ...
            function c(a, b) {
                ...
                return c
                    ? ((b = c.operator),
                      (a = a[c.property]),
                      (c = c.value),
                      ("\x3e" === b && a > c) || ("\x3c" === b && a < c) || ("\x3e\x3d" === b && a >= c) || ("\x3c\x3d" === b && a <= c) || ("\x3d\x3d" === b && a == c) || ("\x3d\x3d\x3d" === b && a === c) ? !0 : !1)
                    : !0;
            }
            var b = this,
                e = b.chart,
                ...
                b.dlProcessOptions && b.dlProcessOptions(h),
                    ...
                    m(l, function (d) {
                        ...
                        g &&
                            ...
                            "contrast" === r.color && ((d.contrastColor = D.getContrast(d.color || b.color)), (r.color = h.inside || 0 > w(d.labelDistance, h.distance) || k.stacking ? d.contrastColor : "#000000")),
                            k.cursor && (r.cursor = k.cursor),
                            (p = { fill: h.backgroundColor, stroke: h.borderColor, "stroke-width": h.borderWidth, r: h.borderRadius || 0, rotation: t, padding: h.padding, zIndex: 1 }),
                        ...
                        !l || (g && E(n))
                            ? g &&
                              ...
                              (l
                                  ? (p.text = n)
                                  : ((l = d.dataLabel = t ? D.text(n, 0, -9999, h.useHTML).addClass("highcharts-data-label") : D.label(n, 0, -9999, h.shape, null, null, h.useHTML, null, "data-label")),
                                    l.addClass(" highcharts-data-label-color-" + d.colorIndex + " " + (h.className || "") + (h.useHTML ? " highcharts-tracker" : ""))),
                              l.attr(p),
                              l.css(r).shadow(h.shadow),
                              l.added || l.add(z),
                              b.alignDataLabel(d, l, h, null, u))
                            : ((d.dataLabel = l = l.destroy()), m && (d.connector = m.destroy()));
                    });
        ...
        c.prototype.alignDataLabel = function (a, b, c, e, f) {
            ...
            if (
                ...
                (e = h({ x: k ? this.yAxis.len - m : l, y: Math.round(k ? this.xAxis.len - l : m), width: 0, height: 0 }, e)),
                h(c, { width: n.width, height: n.height }),
                q
                    ? ((g = !1),
                      (l = d.renderer.rotCorr(p, q)),
                      (l = { x: e.x + c.x + e.width / 2 + l.x, y: e.y + c.y + { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * e.height }),
                      b[f ? "attr" : "animate"](l).attr({ align: r }),
                      (m = (q + 720) % 360),
                      (m = 180 < m && 360 > m),
                      "left" === r ? (l.y -= m ? n.height : 0) : "center" === r ? ((l.x -= n.width / 2), (l.y -= n.height / 2)) : "right" === r && ((l.x -= n.width), (l.y -= m ? 0 : n.height)),
                      (b.placed = !0),
                      (b.alignAttr = l))
                    : (b.align(c, null, e), (l = b.alignAttr)),
                ...
                b[f ? "attr" : "animate"]({ anchorX: k ? d.plotWidth - a.plotY : a.plotX, anchorY: k ? d.plotHeight - a.plotX : a.plotY });
        ...
        l.pie &&
                        ...
                        a.dataLabel &&
                            (a.visible
                                ? (J[a.half].push(a),
                                  ...
                                  !E(k.style.width) &&
                                      !E(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) &&
                                      a.dataLabel.getBBox().width > n &&
                                      (a.dataLabel.css({ width: 0.7 * n }), (a.dataLabel.shortened = !0)))
                            ...
                            for (
                                d.sortByAngle(b, c - 0.5),
                                    0 < d.maxLabelDistance &&
                                        ((l = Math.max(0, F - C - d.maxLabelDistance)),
                                        (n = Math.min(F + C + d.maxLabelDistance, f.plotHeight)),
                                        m(b, function (a) {
                                            0 < a.labelDistance &&
                                                a.dataLabel &&
                                                ((a.top = Math.max(0, F - C - a.labelDistance)),
                                                (a.bottom = Math.min(F + C + a.labelDistance, f.plotHeight)),
                                                (x = a.dataLabel.getBBox().height || 21),
                                                (a.distributeBox = { target: a.labelPos[1] - a.top + x / 2, size: x, rank: a.y }),
                                ...
                                (e = b[R]),
                                    ...
                                    (g._attr = { visibility: A, align: K[6] }),
                                    (g._pos = { x: O + k.x + ({ left: h, right: -h }[K[6]] || 0), y: N + k.y - 10 }),
                                    (K.x = O),
                                    (K.y = N),
                                    w(k.crop, !0) &&
                                        ((v = g.getBBox().width),
                                        (l = null),
                                        O - v < h && 1 === c ? ((l = Math.round(v - O + h)), (S[3] = Math.max(l, S[3]))) : O + v > q - h && 0 === c && ((l = Math.round(O + v - q + h)), (S[1] = Math.max(l, S[1]))),
                                        0 > N - Q / 2 ? (S[0] = Math.max(Math.round(-N + Q / 2), S[0])) : N + Q / 2 > r && (S[2] = Math.max(Math.round(N + Q / 2 - r), S[2])),
                                        (g.sideOverflow = l));
                    }),
                    0 === D(S) || this.verifyDataLabelOverflow(S)) &&
                    ...
                    l &&
                        m(this.points, function (a) {
                            ...
                            if ((g = a.dataLabel) && g._pos && a.visible && 0 < a.labelDistance) {
                                ...
                                if ((b = !y))
                                    (a.connector = y = f.renderer
                                        .path()
                                        .addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : ""))
                                        .add(d.dataLabelsGroup)),
                                        y.attr({ "stroke-width": l, stroke: k.connectorColor || a.color || "#666666" });
                                y[b ? "attr" : "animate"]({ d: d.connectorPath(a.labelPos) });
                                y.attr("visibility", A);
            ...
            (l.pie.prototype.connectorPath = function (a) {
                ...
                return w(this.options.dataLabels.softConnector, !0)
                    ? ["M", b + ("left" === a[6] ? 5 : -5), c, "C", b, c, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3], "L", a[4], a[5]]
                ...
                m(
                    ...
                    function (a) {
                        ...
                        b &&
                            ...
                            ((a = b._pos)
                                ? (b.sideOverflow &&
                                      ((b._attr.width = b.getBBox().width - b.sideOverflow), b.css({ width: b._attr.width + "px", textOverflow: (this.options.dataLabels.style || {}).textOverflow || "ellipsis" }), (b.shortened = !0)),
                                  b.attr(b._attr),
            ...
            (l.pie.prototype.verifyDataLabelOverflow = function (a) {
                var b = this.center,
                    ...
                    h = null !== c.size;
                h ||
                    (null !== d[0] ? (k = Math.max(b[2] - Math.max(a[1], a[3]), f)) : ((k = Math.max(b[2] - a[1] - a[3], f)), (b[0] += (a[3] - a[1]) / 2)),
                    null !== d[1] ? (k = Math.max(Math.min(k, b[2] - Math.max(a[0], a[2])), f)) : ((k = Math.max(Math.min(k, b[2] - a[0] - a[2]), f)), (b[1] += (a[0] - a[2]) / 2)),
                    k < b[2] ? ((b[2] = k), (b[3] = Math.min(e(c.innerSize || 0, k), k)), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : (h = !0));
                return h;
            }));
        l.column &&
            (l.column.prototype.alignDataLabel = function (a, b, e, f, k) {
                ...
                l &&
                    ...
                    0 < l && (f.height -= l),
                    d && (f = { x: h.yAxis.len - f.y - f.height, y: h.xAxis.len - f.x - f.width, width: f.height, height: f.width }),
            ...
            w = function (a) {
                ...
                if (a && (!a.alignAttr || a.placed))
                    return (
                        ...
                        { x: c.x + (b.translateX || 0), y: c.y + (b.translateY || 0) - e, width: a.width - f, height: a.height - f }
                    );
            };
            for (q = 0; q < f; q++) if ((m = a[q])) (m.oldOpacity = m.opacity), (m.newOpacity = 1), (m.absoluteBox = w(m));
            a.sort(function (a, c) {
                return (c.labelrank || 0) - (a.labelrank || 0);
            });
            for (q = 0; q < f; q++)
                for (l = (w = a[q]) && w.absoluteBox, m = q + 1; m < f; ++m)
                    if (((c = (e = a[m]) && e.absoluteBox), l && c && w !== e && 0 !== w.newOpacity && 0 !== e.newOpacity && (c = z(l.x, l.y, l.width, l.height, c.x, c.y, c.width, c.height))))
                    ...
                    a.oldOpacity !== b &&
                        (a.alignAttr && a.placed
                            ? (b
                              ...
                              a[a.isOld ? "animate" : "attr"](a.alignAttr, null, c))
                            : a.attr({ opacity: b })),
                    (a.isOld = !0));
            });
        };
    ...
    (function (a) {
        ...
        H = a.TrackerMixin = {
                ...
                a._hasTracking ||
                    (r(a.trackerGroups, function (d) {
                        if (a[d]) {
                            ...
                            a.options.cursor && a[d].css(m).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            ...
            drawTrackerGraph: function () {
                var a = this,
                    ...
                    y = "rgba(192,192,192," + (p ? 0.0001 : 0.002) + ")";
                if (e && !c) for (m = e + 1; m--; ) "M" === d[m] && d.splice(m + 1, 0, d[m + 1] - l, d[m + 2], "L"), ((m && "M" === d[m]) || m === e) && d.splice(m, 0, "L", d[m - 2] + l, d[m - 1]);
                g
                    ? g.attr({ d: d })
                    : a.graph &&
                      ((a.tracker = k
                          .path(d)
                          .attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: y, fill: c ? y : "none", "stroke-width": a.graph.strokeWidth() + (c ? 0 : 2 * l), zIndex: 2 })
                          .add(a.group)),
        ...
        y(D.prototype, {
            ...
            pan: function (a, b) {
                ...
                r("xy" === b ? [1, 0] : [1], function (b) {
                    ...
                    m = n - g;
                    0 < m && ((n = g), (h -= m));
                    b.series.length && h !== l.min && n !== l.max && (b.setExtremes(h, n, !1, !1, { trigger: "pan" }), (e = !0));
                    c[d] = f;
                });
                e && c.redraw(!1);
        ...
        y(d.prototype, {
            select: function (a, b) {
                ...
                c.firePointEvent(a ? "select" : "unselect", { accumulate: b }, function () {
                    ...
                    c.setState(a && "select");
                    b ||
                        r(f.getSelectedPoints(), function (a) {
                ...
                if (!((a === this.state && !b) || (this.selected && "select" !== a) || !1 === h.enabled || (a && (g || (m && !1 === p.enabled))) || (a && r.states && r.states[a] && !1 === r.states[a].enabled))) {
                    ...
                    if (this.graphic)
                        ...
                        if (a && p) {
                            ...
                            if (t) t[b ? "animate" : "attr"]({ x: z.x, y: z.y });
                    ...
                    (c = h.halo) && c.size
                        ? (w || (e.halo = w = u.renderer.path().add((this.graphic || t).parentGroup)),
                          w.show()[b ? "animate" : "attr"]({ d: this.haloPath(c.size) }),
                          w.attr({ class: "highcharts-halo highcharts-color-" + k(this.colorIndex, e.colorIndex) + (this.className ? " " + this.className : ""), zIndex: -1 }),
                          (w.point = this),
                          w.attr(y({ fill: this.color || e.color, "fill-opacity": c.opacity }, c.attributes)))
                        : w && w.point && w.point.haloPath && w.animate({ d: w.point.haloPath(0) }, null, w.hide);
                    this.state = a;
        ...
        y(b.prototype, {
            ...
            setState: function (a) {
                ...
                if (
                    b.state !== a &&
                    (r([b.group, b.markerGroup, b.dataLabelsGroup], function (c) {
                    ...
                    for (f = { "stroke-width": f }, d.animate(f, k(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c]; ) b["zone-graph-" + c].attr(f), (c += 1);
            },
    ...
    (function (a) {
        ...
        C.prototype.setResponsive = function (f) {
            ...
            var c = a.merge.apply(
                ...
                m = m.toString() || void 0;
            m !== (e && e.ruleIds) && (e && this.update(e.undoOptions, f), m ? ((this.currentResponsive = { ruleIds: m, mergedOptions: c, undoOptions: this.currentOptions(c) }), this.update(c, f)) : (this.currentResponsive = void 0));
        };
        ...
        C.prototype.currentOptions = function (f) {
            function q(e, c, f, w) {
                ...
                a.objectEach(e, function (a, b) {
                    if (!w && -1 < E(b, ["series", "xAxis", "yAxis"])) for (a = r(a), f[b] = [], k = 0; k < a.length; k++) c[b][k] && ((f[b][k] = {}), q(a[k], c[b][k], f[b][k], w + 1));
                    else h(a) ? ((f[b] = m(a) ? [] : {}), q(a, c[b] || {}, f[b], w + 1)) : (f[b] = c[b] || null);
                });
            }
            var w = {};
